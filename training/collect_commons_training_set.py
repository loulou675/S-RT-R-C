...
TARGETS: dict[str, list[str]] = {
    ...
    "aluminium_drink_can": [
        ...
        "single soda can",
        "single beer can",
        "soft drink can on table",
        "beverage can held in hand",
        "soda can held in hand",
        "opened drink can",
        "empty beverage can",
        "red soda can",
        "energy drink can",
        "crushed beverage can",
        "damaged aluminium can",
        "discarded drink can outdoors",
        "beverage can litter",
        "beverage can top view",
        "beverage can side view",
    ],
