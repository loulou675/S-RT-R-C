...
TARGETS: dict[str, dict[str, Any]] = {
    ...
    "disposable_cutlery": {"bin": "landfill", "queries": ["used disposable plastic cutlery", "discarded plastic spoon fork", "single use plastic cutlery waste", "used disposable chopsticks", "wrapped takeaway chopsticks"], "target": 100},
...
def title_matches(class_code: str, title: str) -> bool:
    ...
    rules = {
        ...
        "disposable_cutlery": (r"disposable.*(cutlery|utensil|chopstick)|plastic (spoon|fork|knife)|single.?use.*(spoon|fork|knife)|takeaway chopsticks", r"metal|kitchen set|illustration|drawing"),
