...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=e=>[12,10,1,6][[`u32`,`f16`,`f32`,`i32`].indexOf(e)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},zn=(e,t)=>new Rn(e,t)}),Bn,Vn,Hn,Un,Wn,Gn,Y,Kn,qn,Jn=m(()=>{F(),R(),B(),J(),Bn=(e,t)=>{if(!e||e.length!==1)throw Error(`Transpose requires 1 input.`);if(t.length!==0&&t.length!==e[0].dims.length)throw Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Vn=(e,t)=>t.length===0?[...Array(e).keys()].reverse():t,Hn=(e,t)=>L.sortBasedOnPerm(e,Vn(e.length,t)),Un=(e,t,n,r)=>{let i=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let n=0;n<t;++n)i+=`a[${e[n]}]=i[${n}];`;return i+=`return a;}`},Wn=(e,t)=>{let n=[],r=[];for(let i=0;i<e.length;++i)e[i]!==1&&n.push(e[i]),e[t[i]]!==1&&r.push(t[i]);return{newShape:n,newPerm:r}},Gn=(e,t)=>{let n=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<n)return!1;n=e[r]}return!0},Y=(e,t)=>{let n=e.dataType,r=e.dims.length,i=Vn(r,t),a=Hn(e.dims,i),o=e.dims,s=a,c=r<2||Gn(i,e.dims),l;if(c)return l=e=>{let t=K(`input`,n,o,4),r=q(`output`,n,s,4);return`
  ${e.registerUniform(`output_size`,`u32`).declareVariables(t,r)}
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.output_size`)}
    output[global_idx] = input[global_idx];
  }`},{name:`TransposeCopy`,shaderCache:{inputDependencies:[`type`]},getRunData:()=>{let t=L.size(a);return{outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(t/64/4)},programUniforms:[{type:12,data:Math.ceil(t/4)}]}},getShaderSource:l};let{newShape:u,newPerm:d}=Wn(e.dims,i),f=L.areEqual(d,[2,3,1]),p=L.areEqual(d,[3,1,2]);return u.length===2||f||p?(o=f?[u[0],u[1]*u[2]]:p?[u[0]*u[1],u[2]]:u,s=[o[1],o[0]],l=e=>{let t=K(`a`,n,o.length),r=q(`output`,n,s.length);return`
  ${e.registerUniform(`output_size`,`u32`).declareVariables(t,r)}
...
`)}
        }`},getRunData:()=>({outputs:[{dims:c,dataType:a}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:[{type:12,data:m},...U(l,c)]})}},br=(e,t)=>{let n=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(e=>n.push(Number(e))),z({axes:n,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},X=(e,t,n,r)=>{let i=e.inputs,a=i.length===1?n:br(i,n);e.compute(yr(t,{hint:a.cacheKey,inputDependencies:[`rank`]},[i[0]],a.noopWithEmptyAxes&&a.axes.length===0?vr:r,a.axes,i[0].dataType,a.keepDims,a.noopWithEmptyAxes),{inputs:[0]})},xr=(e,t)=>{_r(e.inputs),X(e,`ReduceLogSum`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += ${e.getByIndices(`input_indices`)};`,`value = log(value);`])},Sr=(e,t)=>{_r(e.inputs),X(e,`ReduceL1`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += abs(${e.getByIndices(`input_indices`)});`,``])},Z=(e,t)=>{_r(e.inputs),X(e,`ReduceL2`,t,(e,t)=>[`var t = ${t.type.value}(0); var value = ${t.type.value}(0);`,``,`t = ${e.getByIndices(`input_indices`)}; value += (t * t);`,`value = sqrt(value);`])},Cr=(e,t)=>{_r(e.inputs),X(e,`ReduceLogSumExp`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += exp(${e.getByIndices(`input_indices`)});`,`value = log(value);`])},Q=(e,t)=>{_r(e.inputs),X(e,`ReduceMax`,t,(e,t,n)=>{let r=[];for(let t=0;t<e.rank;t++)(n.indexOf(t)>=0||n.length===0)&&r.push(e.indicesSet(`input_indices`,t,0));return[`${r.join(`
`)}`,`var value = ${e.getByIndices(`input_indices`)};`,`value = max(value, ${e.getByIndices(`input_indices`)});`,``]})},wr=(e,t)=>{_r(e.inputs),X(e,`ReduceMean`,t,(t,n,r)=>{let i=1;for(let n=0;n<t.rank;n++)(r.indexOf(n)>=0||r.length===0)&&(i*=e.inputs[0].dims[n]);return[`var sum = f32(0);`,``,`sum += f32(${t.getByIndices(`input_indices`)});`,`let value = ${n.type.value}(sum / ${i});`]})},Tr=(e,t)=>{_r(e.inputs),X(e,`ReduceMin`,t,(e,t,n)=>{let r=[];for(let t=0;t<e.rank;t++)(n.indexOf(t)>=0||n.length===0)&&r.push(`input_indices[${t}] = 0;`);return[`${r.join(`
`)}`,`var value = ${e.getByIndices(`input_indices`)};`,`value = min(value, ${e.getByIndices(`input_indices`)});`,``]})},Er=(e,t)=>{_r(e.inputs),X(e,`ReduceProd`,t,(e,t)=>[`var value = ${t.type.storage}(1);`,``,`value *= ${e.getByIndices(`input_indices`)};`,``])},Dr=(e,t)=>{_r(e.inputs),X(e,`ReduceSum`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += ${e.getByIndices(`input_indices`)};`,``])},Or=(e,t)=>{_r(e.inputs),X(e,`ReduceSumSquare`,t,(e,t)=>[`var t = ${t.type.value}(0); var value = ${t.type.value}(0);`,``,`t = ${e.getByIndices(`input_indices`)}; value += t * t;`,``])},kr=(e,t,n)=>{if(t.length===0)return n;let r=1,i=1;for(let n=0;n<t.length;n++)t.indexOf(n)===-1?r*=e[n]:i*=e[n];return i<32&&r>1024},Ar=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?wr(e,t):or(e,t)},jr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sr(e,t):sr(e,t)},Mr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Z(e,t):cr(e,t)},Nr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cr(e,t):lr(e,t)},Pr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Q(e,t):ur(e,t)},Fr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Tr(e,t):dr(e,t)},Ir=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Er(e,t):fr(e,t)},Lr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Dr(e,t):pr(e,t)},Rr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Or(e,t):mr(e,t)},zr=(e,t)=>{kr(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?xr(e,t):hr(e,t)}}),Vr,Hr,Ur,Wr,Gr=m(()=>{F(),B(),Br(),Vr=e=>{if(!e||e.length===0||e.length>2)throw Error(`ArgMinMaxOp op requires 1 or 2 inputs.`);if(e[0].dataType!==1)throw Error(`Invalid input type.`)},Hr=(e,t)=>{Vr(e.inputs),e.compute(yr(`ArgMin`,{hint:t.cacheKey,inputDependencies:[`rank`]},[e.inputs[0]],(e,n,r)=>{let i=[];for(let t=0;t<e.rank;t++)(r.indexOf(t)>=0||r.length===0)&&i.push(`input_indices[${t}] = 0;`);return[`${i.join(`
...
var best_index : i32 = 0;`,`if (${e.getByIndices(`input_indices`)} ${t.selectLastIndex>0?`>=`:`>`} value) {
  ...
  }`,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:l?[{type:12,data:c},...U(a)]:[{type:12,data:c}]})}},ri=e=>z(e),ii=(e,t)=>{let{inputs:n,outputCount:r}=e,i=ri({...t,outputCount:r});if(k.webgpu.validateInputContent&&ti(n,i),t.trainingMode)throw Error(`BatchNormalization trainingMode is not supported yet.`);e.compute(ni(n,i))}}),oi,si,ci,li=m(()=>{R(),J(),oi=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![320,640,1280].includes(e[0].dims[2]))throw Error(`number of channels should be 320, 640 or 1280`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},si=e=>{let t=e[0].dims,n=e[0].dims[2],r=L.size(t)/4,i=e[0].dataType,a=K(`input`,i,t,4),o=K(`bias`,i,[n],4),s=K(`residual`,i,t,4),c=q(`output`,i,t,4);return{name:`BiasAdd`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:e=>`
  ...
  }`}},ci=e=>{oi(e.inputs),e.compute(si(e.inputs))}}),ui,$,di,fi,pi,mi,hi,gi,_i,vi,yi,bi,xi,Si,Ci,wi,Ti,Ei,Di,Oi,ki,Ai,ji,Mi,Ni,Pi,Fi,Ii,Li,Ri,zi,Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji,Yi,Xi,Zi,Qi,$i,ea=m(()=>{F(),R(),B(),J(),ui=(e,t,n,r,i,a,o)=>{let s=Math.ceil(t/4),c=``;c=typeof i==`string`?`${i}(a)`:i(`a`);let l=K(`inputData`,n,[s],4),u=q(`outputData`,r,[s],4),d=[{name:`vec_size`,type:`u32`}];return o&&d.push(...o),`
  ...
  }`},$=(e,t,n,r,i,a=e.dataType,o,s)=>{let c=[{type:12,data:Math.ceil(L.size(e.dims)/4)}];return o&&c.push(...o),{name:t,shaderCache:{hint:i,inputDependencies:[`type`]},getShaderSource:t=>ui(t,L.size(e.dims),e.dataType,a,n,r,s),getRunData:t=>({outputs:[{dims:e.dims,dataType:a}],dispatchGroup:{x:Math.ceil(L.size(t[0].dims)/64/4)},programUniforms:c})}},di=e=>{e.compute($(e.inputs[0],`Abs`,`abs`))},fi=e=>{e.compute($(e.inputs[0],`Acos`,`acos`))},pi=e=>{e.compute($(e.inputs[0],`Acosh`,`acosh`))},mi=e=>{e.compute($(e.inputs[0],`Asin`,`asin`))},hi=e=>{e.compute($(e.inputs[0],`Asinh`,`asinh`))},gi=e=>{e.compute($(e.inputs[0],`Atan`,`atan`))},_i=e=>{e.compute($(e.inputs[0],`Atanh`,`atanh`))},vi=e=>z(e),yi=(e,t)=>{let n;switch(t.to){case 10:n=`vec4<f16>`;break;case 1:n=`vec4<f32>`;break;case 12:n=`vec4<u32>`;break;case 6:n=`vec4<i32>`;break;case 9:n=`vec4<bool>`;break;default:throw RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute($(e.inputs[0],`Cast`,n,void 0,t.cacheKey,t.to))},bi=e=>{let t,n,r=e.length>=2&&e[1].data!==0,i=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=i?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=i?e[2].getUint16Array()[0]:31743;break;default:throw Error(`Unsupport data type`)}return z({min:t,max:n})},xi=(e,t)=>{let n=t||bi(e.inputs),r=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`Clip`,e=>`clamp(${e}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:`min`,type:r},{name:`max`,type:r}]),{inputs:[0]})},Si=e=>{e.compute($(e.inputs[0],`Ceil`,`ceil`))},Ci=e=>{e.compute($(e.inputs[0],`Cos`,`cos`))},wi=e=>{e.compute($(e.inputs[0],`Cosh`,`cosh`))},Ti=e=>z(e),Ei=(e,t)=>{let n=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`Elu`,e=>`elu_vf32(${e})`,`
...
}`,Oi=e=>{let t=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`Erf`,e=>`erf_vf32(${e})`,Di(t)))},ki=e=>{e.compute($(e.inputs[0],`Exp`,`exp`))},Ai=e=>{e.compute($(e.inputs[0],`Floor`,`floor`))},ji=e=>{let t=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`Gelu`,e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,Di(t)))},Mi=(e,t)=>{let n=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`LeakyRelu`,e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},Ni=e=>{e.compute($(e.inputs[0],`Not`,e=>`!${e}`))},Pi=e=>{e.compute($(e.inputs[0],`Neg`,e=>`-${e}`))},Fi=e=>{e.compute($(e.inputs[0],`Reciprocal`,e=>`1.0/${e}`))},Ii=e=>{let t=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`Relu`,e=>`select(vec4<${t}>(0.0), ${e}, ${e} > vec4<${t}>(0.0))`))},Li=e=>{e.compute($(e.inputs[0],`Sigmoid`,e=>`(1.0 / (1.0 + exp(-${e})))`))},Ri=e=>z(e),zi=(e,t)=>{let n=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`HardSigmoid`,e=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${e} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},Bi=e=>{e.compute($(e.inputs[0],`Sin`,`sin`))},Vi=e=>{e.compute($(e.inputs[0],`Sinh`,`sinh`))},Hi=e=>{e.compute($(e.inputs[0],`Sqrt`,`sqrt`))},Ui=e=>{e.compute($(e.inputs[0],`Tan`,`tan`))},Wi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Gi=e=>{e.compute($(e.inputs[0],`Tanh`,Wi))},Ki=(e=`f32`)=>`
...
`,qi=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ji=e=>{let t=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`FastGelu`,qi,Ki(t),void 0,e.inputs[0].dataType))},Yi=(e,t)=>{let n=H(e.inputs[0].dataType);return e.compute($(e.inputs[0],`ThresholdedRelu`,e=>`select(vec4<${n}>(0.0), ${e}, ${e} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Xi=e=>{e.compute($(e.inputs[0],`Log`,`log`))},Zi=(e,t)=>`
...
`,Qi=e=>`quick_gelu_impl(${e})`,$i=(e,t)=>{let n=H(e.inputs[0].dataType);e.compute($(e.inputs[0],`QuickGelu`,Qi,Zi(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),ta,na,ra,ia=m(()=>{R(),J(),ea(),ta=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![2560,5120,10240].includes(e[0].dims[2]))throw Error(`hidden state should be 2560, 5120 or 10240`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},na=e=>{let t=e[0].dims.slice();t[2]/=2;let n=K(`input`,e[0].dataType,e[0].dims,4),r=K(`bias`,e[0].dataType,[e[0].dims[2]],4),i=q(`output`,e[0].dataType,t,4),a=L.size(t)/4,o=V(e[0].dataType);return{name:`BiasSplitGelu`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${i.setByOffset(`global_idx`,`valueLeft * geluRight`)}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
        ${_}
      }`},oa=(e,t,n,r,i,a,o=n.dataType)=>{let s=n.dims.map(Number),c=r.dims.map(Number),l=!L.areEqual(s,c),u=s,d=L.size(s),f=!1,p=!1,m=[l];if(l){let e=Jt.calcShape(s,c,!1);if(!e)throw Error(`Can't perform binary op on the given tensors`);u=e.slice(),d=L.size(u);let t=L.size(s)===1,n=L.size(c)===1,r=s.length>0&&s[s.length-1]%4==0,i=c.length>0&&c[c.length-1]%4==0;m.push(t),m.push(n),m.push(r),m.push(i);let a=1;for(let e=1;e<u.length;e++){let t=s[s.length-e];if(t===c[c.length-e])a*=t;else break}a%4==0?(p=!0,f=!0):(t||n||r||i)&&(f=!0)}else f=!0;return m.push(f),{name:e,shaderCache:{hint:t+m.map(e=>e.toString()).join(`_`),inputDependencies:[`rank`,`rank`]},getShaderSource:e=>aa(e,s,c,u,f,l,p,i,n.dataType,r.dataType,o,a),getRunData:()=>({outputs:[{dims:u,dataType:o}],dispatchGroup:{x:Math.ceil(d/64/4)},programUniforms:[{type:12,data:Math.ceil(L.size(u)/4)},...U(s,c,u)]})}},sa=(e,t,n,r,i,a)=>{e.compute(oa(t,i??``,e.inputs[0],e.inputs[1],n,r,a))},ca=e=>{sa(e,`Add`,(e,t)=>`${e}+${t}`)},la=e=>{sa(e,`Div`,(e,t)=>`${e}/${t}`)},ua=e=>{sa(e,`Equal`,{scalar:(e,t)=>`u32(${e}==${t})`,vector:(e,t)=>`vec4<u32>(${e}==${t})`},void 0,void 0,9)},da=e=>{sa(e,`Mul`,(e,t)=>`${e}*${t}`)},fa=e=>{let t=K(`input`,e.inputs[0].dataType,e.inputs[0].dims).type.value;sa(e,`Pow`,{scalar:(e,t)=>`pow_custom(${e},${t})`,vector:(e,t)=>`pow_vector_custom(${e},${t})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},pa=e=>{sa(e,`Sub`,(e,t)=>`${e}-${t}`)},ma=e=>{sa(e,`Greater`,{scalar:(e,t)=>`u32(${e}>${t})`,vector:(e,t)=>`vec4<u32>(${e}>${t})`},void 0,void 0,9)},ha=e=>{sa(e,`Less`,{scalar:(e,t)=>`u32(${e}<${t})`,vector:(e,t)=>`vec4<u32>(${e}<${t})`},void 0,void 0,9)},ga=e=>{sa(e,`GreaterOrEqual`,{scalar:(e,t)=>`u32(${e}>=${t})`,vector:(e,t)=>`vec4<u32>(${e}>=${t})`},void 0,void 0,9)},_a=e=>{sa(e,`LessOrEqual`,{scalar:(e,t)=>`u32(${e}<=${t})`,vector:(e,t)=>`vec4<u32>(${e}<=${t})`},void 0,void 0,9)}}),ya,ba,xa,Sa,Ca,wa,Ta=m(()=>{F(),R(),B(),J(),ya=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);let n=e[0],r=n.dataType,i=n.dims.length;e.forEach((e,a)=>{if(a!==0){if(e.dataType!==r)throw Error(`input tensors should be one type`);if(e.dims.length!==i)throw Error(`input tensors should have the same shape`);e.dims.forEach((e,r)=>{if(r!==t&&e!==n.dims[r])throw Error(`non concat dimensions must match`)})}})},ba=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,xa=(e,t)=>{let n=e.length,r=[];for(let i=0;i<n;++i){let a=t.setByOffset(`global_idx`,e[i].getByIndices(`indices`));n===1?r.push(a):i===0?r.push(`if (inputIndex == ${i}u) { ${a} }`):i===n-1?r.push(`else { ${a} }`):r.push(`else if (inputIndex == ${i}) { ${a} }`)}return r.join(`
`)},Sa=(e,t,n,r)=>{let i=L.size(n),a=Array(e.length),o=Array(e.length),s=0,c=[],l=[],u=[{type:12,data:i}];for(let n=0;n<e.length;++n)s+=e[n].dims[t],a[n]=s,l.push(e[n].dims.length),o[n]=K(`input${n}`,r,l[n]),c.push(`rank`),u.push({type:12,data:a[n]});for(let t=0;t<e.length;++t)u.push(...U(e[t].dims));u.push(...U(n));let d=q(`output`,r,n.length),f=d.indicesGet(`indices`,t),p=Array.from(Array(a.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(`,`);return{name:`Concat`,shaderCache:{hint:`${t}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${xa(o,d)}
  }`}},Ca=(e,t)=>{let n=e.inputs,r=n[0].dims,i=L.normalizeAxis(t.axis,r.length);ya(n,i);let a=r.slice();a[i]=n.reduce((e,t)=>e+(t.dims.length>i?t.dims[i]:0),0);let o=n.filter(e=>L.size(e.dims)>0);e.compute(Sa(o,i,a,n[0].dataType),{inputs:o})},wa=e=>z({axis:e.axis})}),Ea,Da,Oa,ka,Aa=m(()=>{F(),R(),Ea=(e,t,n=`f32`)=>{switch(e.activation){case`Relu`:return`value = max(value, ${t}(0.0));`;case`Sigmoid`:return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case`Clip`:return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case`HardSigmoid`:return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case`LeakyRelu`:return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case`Tanh`:return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case``:return``;default:throw Error(`Unsupported activation ${e.activation}`)}},Da=(e,t)=>{e.activation===`Clip`?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation===`HardSigmoid`?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation===`LeakyRelu`&&t.push({type:1,data:e.alpha})},Oa=(e,t)=>{e.activation===`Clip`?t.push({name:`clip_max`,type:`f32`},{name:`clip_min`,type:`f32`}):e.activation===`HardSigmoid`?t.push({name:`alpha`,type:`f32`},{name:`beta`,type:`f32`}):e.activation===`LeakyRelu`&&t.push({name:`alpha`,type:`f32`})},ka=e=>{let t=e?.activation||``;if(t===`HardSigmoid`){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}if(t===`Clip`){let[n,r]=e?.activation_params||[Zt,Qt];return{activation:t,clipMax:r,clipMin:n}}if(t===`LeakyRelu`){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}}),ja,Ma,Na=m(()=>{ja=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw Error(`${e}-component is not supported.`)}},Ma=e=>`
...
`}),Ia,La,Ra=m(()=>{F(),R(),J(),Aa(),Ia=(e,t,n,r,i)=>{let a=r-n;return`
...
`},La=(e,t,n,r,i=!1,a)=>{let o=e[0].dims,s=e[1].dims,c=o[o.length-2],l=s[s.length-1],u=o[o.length-1],d=W(l),f=W(u),p=W(c),m=L.size(n)/d/p,h=e.length>2,g=r?r.slice(0,-2):n.slice(0,-2),_=[L.size(g),c,l],v=[{type:12,data:m},{type:12,data:c},{type:12,data:l},{type:12,data:u}];return Da(t,v),v.push(...U(g,o,s)),h&&v.push(...U(e[2].dims)),v.push(...U(_)),{name:`MatMulNaive`,shaderCache:{hint:`${t.activation};${d};${f};${p};${i}`,inputDependencies:h?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:v}),getShaderSource:r=>{let a=Ln(`batch_dims`,e[0].dataType,g.length),c=K(`a`,e[0].dataType,o.length,f),l=K(`b`,e[1].dataType,s.length,d),u=q(`output`,e[0].dataType,_.length,d),m=V(u.type.tensor),v=Ea(t,u.type.value,m),y=[c,l],b=``;if(h){let t=i?d:1;y.push(K(`bias`,e[2].dataType,e[2].dims.length,t)),b=`${i?`value += bias[col / ${t}];`:`value += ${u.type.value}(bias[row + i]);`}`}let x=[{name:`output_size`,type:`u32`},{name:`M`,type:`u32`},{name:`N`,type:`u32`},{name:`K`,type:`u32`}];Oa(t,x);let S=()=>{let e=`var a_data: ${c.type.value};`;for(let t=0;t<f;t++)e+=`
...
`}return e};return`
  ...
  ${r.mainStart()}
    ...
    ${Ia(`a_indices`,c,c.rank-2,a.rank,`batch_indices`)}
    ${c.indicesSet(`a_indices`,c.rank-2,0)}
    ${c.indicesSet(`a_indices`,c.rank-1,0)}
    let a_offset = ${c.indicesToOffset(`a_indices`)};

    var b_indices: ${l.type.indices};
    ${Ia(`b_indices`,l,l.rank-2,a.rank,`batch_indices`)}
  ...
  `}}}}),za,Ba,Va,Ha,Ua,Wa,Ga,Ka,qa=m(()=>{F(),R(),J(),Aa(),Ra(),Na(),za=(e,t)=>e?`
        ...
        }`,Va=(e,t,n=`f32`,r,i=!1,a=32,o=!1,s=32)=>{let c=t[1]*e[1],l=t[0]*e[0],u=i?c:a,d=i?a:c,f=u/t[0],p=a/t[1];if(!((i&&f===4&&e[1]===4||!i&&(f===3||f===4))&&u%t[0]===0&&a%t[1]===0&&e[0]===4))throw Error(`If transposeA ${i} is true, innerElementSize ${f} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,Ua=e=>e?`let ACached = mm_Asub[k][tileRow + innerRow];`:`let ACached = mm_Asub[tileRow + innerRow][k];`,Wa=(e,t,n=`f32`,r,i=!1,a=32,o=!1,s=32,c=!1)=>{let l=e[1]*t[1],u=e[0]*t[0],d=i?l:a,f=i?a:l;if(f%t[1]!==0||d%t[0]!==0||a%t[1]!==0)throw Error(`tileAHight ${f} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${d} must be divisible by workgroupSize[0]${t[0]}, tileInner ${a} must be divisible by workgroupSize[1]${t[1]}`);let p=f/t[1],m=d/t[0],h=a/t[1],g=c?`
    let localRow = i32(localId.y);
...
`},Ga=(e,t,n,r,i=!1)=>{let[a,o,s,c]=r,l=V(r[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${a.type.indices}) -> ${ja(e,l)} {
      ...
      if(row < uniforms.dim_a_outer && col < uniforms.dim_inner)
      {
        ...
        ${Ia(`aIndices`,o,o.rank-2,a.rank,`batchIndices`)}
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${a.type.indices}) -> ${ja(e,l)} {
      ...
      if(row < uniforms.dim_inner && col < uniforms.dim_b_outer)
      {
        ...
        ${Ia(`bIndices`,s,s.rank-2,a.rank,`batchIndices`)}
    ...
    `},Ka=(e,t,n,r,i=!1,a)=>{let o=e[0].dims,s=e[1].dims,c=o.slice(0,-2),l=s.slice(0,-2),u=r?r.slice(0,-2):n.slice(0,-2),d=L.size(u),f=o[o.length-2],p=o[o.length-1],m=s[s.length-1],h=p%4==0&&m%4==0,g=f<=8?[4,1,1]:[4,4,1],_=[8,8,1],v=[Math.ceil(m/_[0]/g[0]),Math.ceil(f/_[1]/g[1]),Math.ceil(d/_[2]/g[2])],y=h?4:1,b=[...c,f,p/y],x=b.length,S=[...l,p,m/y],C=S.length,w=[d,f,m/y],ee=[{type:6,data:f},{type:6,data:m},{type:6,data:p}];Da(t,ee),ee.push(...U(u,b,S));let T=[`rank`,`rank`],E=e.length>2;return E&&(ee.push(...U(e[2].dims)),T.push(`rank`)),ee.push(...U(w)),{name:`MatMul`,shaderCache:{hint:`${g};${t.activation};${h};${i}`,inputDependencies:T},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:ee}),getShaderSource:n=>{let r=u.length,a=Ln(`batchDims`,e[0].dataType,r,1),o=V(e[0].dataType),s=K(`a`,e[0].dataType,x,y),c=K(`b`,e[1].dataType,C,y),l=q(`result`,e[0].dataType,w.length,y),d=[s,c];if(E){let t=i?y:1;d.push(K(`bias`,e[2].dataType,e[2].dims.length,t))}let f=[{name:`dim_a_outer`,type:`i32`},{name:`dim_b_outer`,type:`i32`},{name:`dim_inner`,type:`i32`}];Oa(t,f);let p=V(l.type.tensor),m=Ea(t,l.type.value,p),v=Ga(y,E,m,[a,s,c,l],i);return`
  ${n.registerUniforms(f).registerInternalVariables(a).declareVariables(...d,l)}
  ${v}
  ${h?Va(g,_,o,a):Wa(g,_,o,a)}
                   `}}}}),Ja,Ya,Xa=m(()=>{F(),Kt(),J(),Aa(),Na(),Fa(),qa(),Ja=(e,t,n,r,i=!1,a,o=4,s=4,c=4,l=`f32`)=>{let u=e=>{switch(e){case 1:return`resData = x[xIndex];`;case 3:return`resData = vec3<${l}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return`resData = x[xIndex / 4];`;default:throw Error(`innerElementSize ${e} is not supported.`)}},d=e=>{switch(e){case 1:return`return w[row * i32(uniforms.w_shape[3]) + colIn];`;case 4:return`return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];`;default:throw Error(`innerElementSize ${e} is not supported.`)}},f=e?`
    ...
    return ${ja(s,l)}(0.0);`,x=ja(c,l),S=ja(e?o:s,l),C=ja(e?s:o,l),w=Ea(a,x,l);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${x}) {
    ...
    }`},Ya=(e,t,n,r,i,a,o,s,c)=>{let l=t.format===`NHWC`,u=l?e[0].dims[3]:e[0].dims[1],d=n[0],f=l?n[2]:n[3],p=l?n[1]:n[2],m=l?n[3]:n[1],h=l&&(u%4==0||u%3==0)&&m%4==0,g=l?m:f*p,_=l?f*p:m,v=[8,8,1],y=r<=8?[4,1,1]:[4,4,1],b=[Math.ceil(g/v[0]/y[0]),Math.ceil(_/v[1]/y[1]),Math.ceil(d/v[2]/y[2])];I(`verbose`,()=>`[conv2d_mm_webgpu] dispatch = ${b}`);let x=h?l&&u%4!=0?3:4:1,S=v[1]*y[1],C=v[0]*y[0],w=Math.max(v[0]*x,v[1]),ee=r%S===0,T=i%C===0,E=a%w===0,D=h?[x,4,4]:[1,1,1],O=[{type:6,data:r},{type:6,data:i},{type:6,data:a},{type:6,data:[t.pads[0],t.pads[1]]},{type:6,data:t.strides},{type:6,data:t.dilations}];Da(t,O),O.push(...U(e[0].dims,e[1].dims));let k=[`rank`,`rank`];return o&&(O.push(...U(e[2].dims)),k.push(`rank`)),O.push(...U(n)),{name:`Conv2DMatMul`,shaderCache:{hint:`${t.cacheKey};${x};${h};${ee};${T};${E};${S};${C};${w}`,inputDependencies:k},getRunData:()=>({outputs:[{dims:c?c(n):n,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:O}),getShaderSource:r=>{let i=[{name:`dim_a_outer`,type:`i32`},{name:`dim_b_outer`,type:`i32`},{name:`dim_inner`,type:`i32`},{name:`pad`,type:`i32`,length:2},{name:`stride`,type:`i32`,length:2},{name:`dilation`,type:`i32`,length:2}];Oa(t,i);let a=h?4:1,c=V(e[0].dataType),u=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${c}>`:c}) {
        ...
        ${u}
        ${Ja(l,ee,T,E,o,t,D[0],D[1],D[2],c)}
        ${h?Va(y,v,c,void 0,!l,w):Wa(y,v,c,void 0,!l,w,!1,void 0,s)}`}}}}),Za,Qa,$a,eo,to,no,ro,io,ao=m(()=>{F(),Kt(),R(),J(),Aa(),Na(),Za=e=>{let t=1;for(let n=0;n<e.length;n++)t*=e[n];return t},Qa=e=>typeof e==`number`?[e,e,e]:e,$a=(e,t)=>t<=1?e:e+(e-1)*(t-1),eo=(e,t,n,r=1)=>{let i=$a(t,r);return Math.floor((e[0]*(n-1)-n+i)/2)},to=(e,t,n,r,i)=>{i??=eo(e,t[0],r[0]);let a=[0,0,0,n];for(let n=0;n<3;n++)e[n]+2*i>=t[n]&&(a[n]=Math.trunc((e[n]-t[n]+2*i)/r[n]+1));return a},no=(e,t,n,r,i,a,o,s,c,l)=>{let u,d,f,p;if(e===`VALID`&&(e=0),typeof e==`number`){u={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=to([t,n,r,1],[s,c,l],1,[i,a,o],e);d=m[0],f=m[1],p=m[2]}else if(Array.isArray(e)){if(!e.every((e,t,n)=>e===n[0]))throw Error(`Unsupported padding parameter: ${e}`);u={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=to([t,n,r,1],[s,c,l],1,[i,a,o],e[0]);d=m[0],f=m[1],p=m[2]}else if(e===`SAME_UPPER`){d=Math.ceil(t/i),f=Math.ceil(n/a),p=Math.ceil(r/o);let e=(d-1)*i+s-t,m=(f-1)*a+c-n,h=(p-1)*o+l-r,g=Math.floor(e/2),_=e-g,v=Math.floor(m/2),y=m-v,b=Math.floor(h/2);u={top:v,bottom:y,left:b,right:h-b,front:g,back:_}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:u,outDepth:d,outHeight:f,outWidth:p}},ro=(e,t,n,r,i,a=!1,o=`channelsLast`)=>{let s,c,l,u,d;if(o===`channelsLast`)[s,c,l,u,d]=e;else if(o===`channelsFirst`)[s,d,c,l,u]=e;else throw Error(`Unknown dataFormat ${o}`);let[f,,p,m,h]=t,[g,_,v]=Qa(n),[y,b,x]=Qa(r),S=$a(p,y),C=$a(m,b),w=$a(h,x),{padInfo:ee,outDepth:T,outHeight:E,outWidth:D}=no(i,c,l,u,g,_,v,S,C,w),O=a?f*d:f,k=[0,0,0,0,0];return o===`channelsFirst`?k=[s,O,T,E,D]:o===`channelsLast`&&(k=[s,T,E,D,O]),{batchSize:s,dataFormat:o,inDepth:c,inHeight:l,inWidth:u,inChannels:d,outDepth:T,outHeight:E,outWidth:D,outChannels:O,padInfo:ee,strideDepth:g,strideHeight:_,strideWidth:v,filterDepth:p,filterHeight:m,filterWidth:h,effectiveFilterDepth:S,effectiveFilterHeight:C,effectiveFilterWidth:w,dilationDepth:y,dilationHeight:b,dilationWidth:x,inShape:e,outShape:k,filterShape:t}},io=(e,t,n,r,i,a)=>{let o=a===`channelsLast`;o?e[0].dims[3]:e[0].dims[1];let s=[64,1,1],c={x:n.map((e,t)=>t)},l=[Math.ceil(Za(c.x.map(e=>n[e]))/s[0]),1,1];I(`verbose`,()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let u=[{type:12,data:L.size(n)},{type:12,data:r},{type:12,data:i},{type:12,data:t.strides},{type:12,data:t.dilations}];Da(t,u),u.push(...U(e[0].dims,e[1].dims));let d=[`rank`,`rank`],f=e.length===3;return f&&(u.push(...U(e[2].dims)),d.push(`rank`)),u.push(...U(n)),{name:`Conv3DNaive`,shaderCache:{hint:`${t.cacheKey};${o};1;${f}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:u}),getShaderSource:a=>{let s=[{name:`output_size`,type:`u32`},{name:`filter_dims`,type:`u32`,length:r.length},{name:`pads`,type:`u32`,length:i.length},{name:`strides`,type:`u32`,length:t.strides.length},{name:`dilations`,type:`u32`,length:t.dilations.length}];Oa(t,s);let c=V(e[0].dataType),l=K(`x`,e[0].dataType,e[0].dims.length,1),u=K(`W`,e[1].dataType,e[1].dims.length,1),d=[l,u],p=q(`result`,e[0].dataType,n.length,1),m=``;if(f){let t=K(`bias`,e[2].dataType,e[2].dims.length,1);d.push(t),m+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${c} {
          return bias[${o?G(`coords`,4,5):G(`coords`,1,5)}];
        }`}let h=ja(1,c),g=Ea(t,h,c);return`
            ${m}
          ...
          }`}}}}),oo,so,co=m(()=>{F(),R(),J(),Aa(),oo=(e,t,n,r)=>{let i=e.length>2,a=i?`value += b[output_channel];`:``,o=e[0].dims,s=e[1].dims,c=t.format===`NHWC`,l=c?n[3]:n[1],u=l/t.group,d=c&&u>=4?W(l):1,f=L.size(n)/d,p=[{type:12,data:f},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:u}];Da(t,p),p.push(...U(o,[s[0],s[1],s[2],s[3]/d]));let m=i?[`rank`,`rank`,`rank`]:[`rank`,`rank`];return p.push(...U([n[0],n[1],n[2],n[3]/d])),{name:`GroupedConv`,shaderCache:{hint:`${t.cacheKey}_${d}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:p}),getShaderSource:r=>{let l=q(`output`,e[0].dataType,n.length,d),u=V(l.type.tensor),f=Ea(t,l.type.value,u),p=K(`x`,e[0].dataType,o.length),m=K(`w`,e[1].dataType,s.length,d),h=[p,m];i&&h.push(K(`b`,e[2].dataType,e[2].dims,d));let g=[{name:`output_size`,type:`u32`},{name:`dilations`,type:`u32`,length:t.dilations.length},{name:`strides`,type:`u32`,length:2},{name:`pads`,type:`u32`,length:2},{name:`output_channels_per_group`,type:`u32`}];Oa(t,g);let _=c?`
  ...
  }`}}},so=(e,t,n,r)=>{let i=e.length>2,a=W(n[3]),o=W(n[2]),s=L.size(n)/a/o,c=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/a],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/a],u=[n[0],n[1],n[2],n[3]/a],d=[{type:12,data:s},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Da(t,d),d.push(...U(c,l,u));let f=(o-1)*t.strides[1]+l[1];return{name:`GroupedConv-Vectorize`,shaderCache:{hint:`${t.cacheKey};${a};${o};${f};${l[0]};${l[1]}`,inputDependencies:i?[`rank`,`rank`,`type`]:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:n=>{let r=q(`output`,e[0].dataType,u.length,a),s=V(r.type.tensor),d=Ea(t,r.type.value,s),p=K(`x`,e[0].dataType,c.length,a),m=K(`w`,e[1].dataType,l.length,a),h=[p,m];i&&h.push(K(`b`,e[2].dataType,e[2].dims,a));let g=i?`value += b[output_channel];`:``,_=[{name:`output_size`,type:`u32`},{name:`strides`,type:`i32`,length:2},{name:`pads`,type:`i32`,length:2}];return Oa(t,_),`
  ...
  ${n.mainStart()}
  ...
  }`}}}}),lo,uo,fo,po,mo,ho,go,_o,vo,yo=m(()=>{R(),Xa(),ao(),qa(),co(),Aa(),Ra(),Jn(),lo=(e,t,n,r,i,a)=>{let o=e[0],s=e.slice(a?1:2,a?3:4),c=s.length,l=t[0],u=t.slice(2).map((e,t)=>e+(e-1)*(n[t]-1)),d=s.map((e,t)=>e+r[t]+r[t+c]).map((e,t)=>Math.floor((e-u[t]+i[t])/i[t]));return d.splice(0,0,o),d.splice(a?3:1,0,l),d},uo=[2,3,1,0],fo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw Error(`Conv requires 2 or 3 inputs`);if(e[0].dims.length>5)throw Error(`greater than 5D is not supported`);if(e[0].dims.length!==e[1].dims.length)throw Error(`filter does not have same dimension as input`);if(e[0].dims[t.format===`NHWC`?e[0].dims.length-1:1]!==e[1].dims[1]*t.group)throw Error(`FILTER_IN_CHANNEL should be equal to DATA_CHANNEL`);if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw Error(`invalid bias`);let n=e[0].dims.length-2;if(t.dilations.length!==n)throw Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw Error(`invalid kernel shape`)},po=(e,t)=>{let n=e.kernelShape.slice();n.length<t[1].dims.length-2&&n.push(...Array(t[1].dims.length-2-n.length).fill(0));for(let e=2;e<t[1].dims.length;++e)n[e-2]===0&&(n[e-2]=t[1].dims[e]);let r=e.pads.slice();Yt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format===`NHWC`,e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:n,pads:r}),i},mo=e=>{let t=ka(e),n=e.format;return{autoPad:[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][e.auto_pad],format:n,dilations:e.dilations,group:e.group,kernelShape:e.kernel_shape,pads:e.pads,strides:e.strides,wIsConst:e.w_is_const(),...t,cacheKey:`${e.format};${t.activation};`}},ho=(e,t,n,r)=>{let i=n.format===`NHWC`,a=lo(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,i);if(n.group!==1){let o=[t[0]];if(i){let r=e.kernelCustomData.wT??e.compute(Y(t[1],uo),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=r),o.push(r)}else o.push(t[1]);t.length===3&&o.push(t[2]),!e.adapterInfo.isArchitecture(`ampere`)&&i&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1?e.compute(so(o,n,a,r),{inputs:o}):e.compute(oo(o,n,a,r),{inputs:o});return}let o=t.length===3,s=t[0].dims[i?1:2],c=t[0].dims[i?2:3],l=t[0].dims[i?3:1],u=t[1].dims[2],d=t[1].dims[3],f=a[i?1:2],p=a[i?2:3],m=a[i?3:1],h=i&&u===s&&d===c&&n.pads[0]===0&&n.pads[1]===0;if(h||u===1&&d===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let u=a[0],d,g,_,v=[];if(i){let r=e.kernelCustomData.wT??e.compute(Y(t[1],uo),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=r),h){let e=s*c*l;d=t[0].reshape([1,u,e]),g=r.reshape([1,e,m]),_=[1,u,m]}else d=t[0].reshape([u,s*c,l]),g=r.reshape([1,l,m]),_=[u,f*p,m];v.push(d),v.push(g)}else d=t[0].reshape([u,l,s*c]),g=t[1].reshape([1,m,l]),_=[u,m,f*p],v.push(g),v.push(d);o&&v.push(t[2]);let y=_[2],b=v[0].dims[v[0].dims.length-1];y<8&&b<8?e.compute(La(v,n,a,_,i,r),{inputs:v}):e.compute(Ka(v,n,a,_,i,r),{inputs:v});return}let g=e.kernelCustomData.wT??e.compute(Y(t[1],uo),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=g);let _=[t[0],g];o&&_.push(t[2]);let v=i?f*p:m,y=i?m:f*p,b=u*d*l;e.compute(Ya(_,n,a,v,y,b,o,!0,r),{inputs:_})},go=(e,t)=>{let n=t.format===`NHWC`,r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],a=[1].concat(t.strides),o=[1].concat(t.dilations),s=[1].concat(t.kernelShape),c=po({...t,pads:i,strides:a,dilations:o,kernelShape:s},r);ho(e,r,c,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])},_o=(e,t,n)=>{let r=n.format===`NHWC`?`channelsLast`:`channelsFirst`,i=po(n,t),a=n.autoPad===`NOTSET`?n.pads:n.autoPad,o=ro(t[0].dims,t[1].dims,n.strides,n.dilations,a,!1,r);e.compute(io(t,i,o.outShape,[o.filterDepth,o.filterHeight,o.filterWidth],[o.padInfo.front,o.padInfo.top,o.padInfo.left],r))},vo=(e,t)=>{if(fo(e.inputs,t),e.inputs[0].dims.length===3)go(e,t);else if(e.inputs[0].dims.length===5)_o(e,e.inputs,t);else{let n=po(t,e.inputs);ho(e,e.inputs,n)}}}),bo,xo=m(()=>{F(),Kt(),R(),J(),bo=(e,t,n)=>{let r=e.length>2,i=t.outputShape,a=t.format===`NHWC`,o=t.group,s=e[1].dims,c=s[2]/o,l=s[3],u=a?W(c):1,d=a&&l===1&&c>=4,f=d?Math.floor(c/4)*4:Math.floor(c/u)*u,p=c-f,m=a?W(l):1,h=a?l===1?u:m:1,g=L.size(i)/m,_=[Math.ceil(g/64),1,1];I(`verbose`,()=>`[conv2d_backprop_webgpu] dispatch = ${_}`);let v=[`rank`,`rank`],y=[t.strides[0],t.strides[1]],b=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],x=[t.dilations[0],t.dilations[1]],S=[b[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),b[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],C=[S[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),S[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],w=[{type:12,data:g},{type:12,data:y},{type:12,data:b},{type:12,data:x},{type:12,data:S},{type:6,data:C},{type:12,data:f},{type:12,data:c},{type:12,data:l},...U(e[0].dims,e[1].dims)];return r&&(w.push(...U(e[2].dims)),v.push(`rank`)),w.push(...U(i)),{name:`ConvTranspose2D`,shaderCache:{hint:`${t.cacheKey};${u}${h}${m}${d}${p}`,inputDependencies:v},getRunData:()=>({dispatchGroup:{x:_[0],y:_[1],z:_[2]},outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:t=>{let n=[{name:`output_size`,type:`u32`},{name:`strides`,type:`u32`,length:y.length},{name:`filter_dims`,type:`u32`,length:b.length},{name:`dilations`,type:`u32`,length:b.length},{name:`effective_filter_dims`,type:`u32`,length:S.length},{name:`pads`,type:`i32`,length:C.length},{name:`input_channels_per_group_int`,type:`u32`},{name:`input_channels_per_group`,type:`u32`},{name:`output_channels_per_group`,type:`u32`}],o=V(e[0].dataType),s=a?1:2,c=a?2:3,l=a?3:1,f=K(`W`,e[1].dataType,e[1].dims.length,h),g=K(`Dy`,e[0].dataType,e[0].dims.length,u),_=[g,f];r&&_.push(K(`bias`,e[2].dataType,[i[l]].length,m));let v=q(`result`,e[0].dataType,i.length,m),x=`
    ...
    ${x}}`}}}}),So,Co,wo,To,Eo,Do,Oo,ko,Ao,jo=m(()=>{xo(),Aa(),Jn(),So=(e,t,n,r,i,a)=>(e-1)*t+n+(r-1)*i+1-a,Co=(e,t,n,r,i)=>{let a=Math.floor(e/2);t===`SAME_UPPER`?(n[r]=a,n[i]=e-a):t===`SAME_LOWER`&&(n[r]=e-a,n[i]=a)},wo=(e,t,n,r,i,a,o,s,c,l)=>{let u=e.length-2,d=l.length===0;c.length<u&&c.push(...Array(u-c.length).fill(0));let f=e[0],p=t[s?3:1]*i;for(let i=0,f=e.length-u-+!!s;i<u;++i,++f){let s=e[f],p=d?s*o[i]:l[i],m=So(s,o[i],a[i],t[f],n[i],p);Co(m,r,a,i,i+u),d&&l.push(o[i]*(s-1)+c[i]+(t[f]-1)*n[i]+1-a[i]-a[i+u])}l.splice(0,0,f),l.splice(s?3:1,0,p)},To=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((e,t)=>e*t,1)===0){n.length=0;for(let e=2;e<t[1].dims.length;++e)n.push(t[1].dims[e])}let r=e.format===`NHWC`;n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let i=e.pads.slice(),a=e.outputShape.slice(),o=e.outputPadding.slice(),s=t[0].dims,c=e.dilations.slice();if(c.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;c=Array(e).fill(1)}let l=e.strides.slice();if(l.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;l=Array(e).fill(1)}wo(s,n,c,e.autoPad,e.group,i,l,r,o,a);let u=Object.assign({},e);return Object.assign(u,{kernelShape:n,pads:i,outputPadding:o,outputShape:a,dilations:c,strides:l}),u},Eo=e=>{let t=ka(e),n=e.format,r=[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][typeof e.autoPad>`u`?0:e.autoPad],i=e.dilations,a=e.group??1,o=e.kernelShape,s=e.pads,c=e.strides,l=e.wIsConst();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,outputPadding:e.outputPadding,outputShape:e.outputShape,pads:s,strides:c,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Do=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw Error(`Conv requires 2 or 3 inputs`);if(e[0].dims.length!==4&&e[0].dims.length!==3)throw Error(`currently only support 2-dimensional conv`);if(e[0].dims.length!==e[1].dims.length)throw Error(`filter does not have same dimension as input`);if(e[0].dims[t.format===`NHWC`?e[0].dims.length-1:1]!==e[1].dims[0])throw Error(`FILTER_IN_CHANNEL should be equal to DATA_CHANNEL`);let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw Error(`invalid bias`);let r=e[0].dims.length-2;if(t.dilations.reduce((e,t)=>e+t,0)>0&&t.dilations.length!==r)throw Error(`dilations should be ${r}D`);if(t.strides.reduce((e,t)=>e+t,0)>0&&t.strides.length!==r)throw Error(`strides should be ${r}D`);if(t.pads.reduce((e,t)=>e+t,0)>0&&t.pads.length!==r*2)throw Error(`pads should be ${r*2}D`);if(t.outputPadding.length!==r&&t.outputPadding.length!==0)throw Error(`output_padding should be ${r}D`);if(t.kernelShape.reduce((e,t)=>e+t,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw Error(`invalid kernel shape`);if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw Error(`invalid output shape`)},Oo=(e,t,n,r)=>{let i=e.kernelCustomData.wT??e.compute(Y(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=i);let a=[t[0],i];t.length===3&&a.push(t[2]),e.compute(bo(a,n,r),{inputs:a})},ko=(e,t)=>{let n=t.format===`NHWC`,r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let s=t.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],o=[1].concat(o),a=[1].concat(a),i=[1].concat(i);let c=t.outputPadding;c=[0].concat(c);let l=To({...t,pads:s,strides:o,dilations:a,kernelShape:i,outputPadding:c},r);Oo(e,r,l,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])},Ao=(e,t)=>{if(Do(e.inputs,t),e.inputs[0].dims.length===3)ko(e,t);else{let n=To(t,e.inputs);Oo(e,e.inputs,n)}}}),Mo,No,Po,Fo=m(()=>{F(),R(),B(),J(),Mo=(e,t,n,r)=>{let i=L.size(t),a=t.length,o=K(`input`,e,a),s=q(`output`,e,a),c=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=L.normalizeAxis(c,a);return{name:`CumSum`,shaderCache:{hint:r.cacheKey,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:12,data:l},...U(t,t)]}),getShaderSource:e=>{let t=` i32(${o.indicesGet(`inputIndices`,`uniforms.axis`)}) `,n=G(`uniforms.input_shape`,`uniforms.axis`,a),i=r.reverse?t+(r.exclusive?` + 1`:``):`0`,c=r.reverse?n:t+(r.exclusive?``:` + 1`);return`
...
`)};
          ...
          }`}}},Zo=(e,t)=>{let n=new Jo(e.inputs,t.equation),r=n.outputDims,i=e.inputs.map((e,t)=>e.dims);e.compute(Xo(i,e.inputs[0].dataType,n,r))},Qo=e=>{let t=e.equation.replace(/\s+/g,``);return z({equation:t})}}),es,ts,ns,rs,is,as=m(()=>{F(),R(),J(),es=e=>{if(!e||e.length!==2)throw Error(`Expand requires 2 input.`);let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,i=t.length<n.length?0:t.length-n.length;for(;r<n.length&&i<t.length;++r,++i)if(n[r]!==t[i]&&n[r]!==1&&t[i]!==1)throw Error(`Expand requires shape to be broadcastable to input`)},ts=(e,t)=>{let n=e.length-t.length,r=[];for(let t=0;t<n;++t)r.push(e[t]);for(let i=0;i<t.length;++i)r.push(t[i]===1?e[i+n]:t[i]);return r},ns=(e,t)=>e.length>t.length?ts(e,t):ts(t,e),rs=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=ns(t,n),i=e[0].dataType,a=i===9||L.size(t)===1,o=i===9||t.length>0&&t[t.length-1]%4==0?4:1,s=a||r.length>0&&r[r.length-1]%4==0?4:1,c=Math.ceil(L.size(r)/s),l=e=>{let n=K(`input`,i,t.length,o),a=q(`output`,i,r.length,s),c;if(i===9){let e=(e,t,r=``)=>`
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
    ${c}`},u=[{type:12,data:c},...U(t,r)];return{name:`Expand`,shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:[`rank`]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:u})}},is=e=>{es(e.inputs),e.compute(rs(e.inputs),{inputs:[0]})}}),os,ss,cs=m(()=>{F(),R(),J(),ea(),os=e=>{let t=e[0].dataType,n=L.size(e[0].dims),r=L.size(e[1].dims),i=r%4==0;return{name:`FastGeluWithBias`,shaderCache:{hint:`${i}`,inputDependencies:[`type`,`type`]},getShaderSource:e=>{let n=K(`x`,t,[1],4),r=K(`bias`,t,[1],4),a=q(`y`,t,[1],4),o=[{name:`output_vec_size`,type:`u32`},{name:`bias_size`,type:`u32`}],s=e=>`
  ...
  ${e.mainStart()}
  ...
  }`}},{inputs:[t],outputs:[-1]})[0]},hs=(e,t)=>{let n=e.inputs,r=n[0].dims,i=n[0].dataType,a=n[1].dims,o=a[a.length-1],s=L.sizeToDimension(a,a.length-1),c=L.sizeFromDimension(r,t.batchDims+o),l=L.sizeToDimension(r,t.batchDims),u=L.sizeFromDimension(r,t.batchDims),d=s/l,f=Array(o),p=c;for(let e=0;e<o;++e)f[o-1-e]=p,p*=r[t.batchDims+o-1-e];let m=ms(e,n[1],f,t.batchDims,r,s,d,u,o),h=t.batchDims+o;if(h>r.length)throw Error(`last dimension of indices must not be larger than rank of input tensor`);let g=a.slice(0,-1).concat(r.slice(h)),_=L.size(g),v=[{type:12,data:_},{type:12,data:c},...U(n[0].dims,m.dims,g)];e.compute({name:`GatherND`,shaderCache:{hint:t.cacheKey,inputDependencies:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:g,dataType:i}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:v}),getShaderSource:e=>{let t=K(`data`,n[0].dataType,n[0].dims.length),r=K(`slice_offsets`,12,m.dims.length),i=q(`output`,n[0].dataType,g.length);return`
          ${e.registerUniform(`output_size`,`u32`).registerUniform(`slice_size`,`u32`).declareVariables(t,r,i)}
            ${e.mainStart()}
            ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.output_size`)}
          let slice_offset = slice_offsets[global_idx / uniforms.slice_size];
          output[global_idx] = data[u32(slice_offset) + global_idx % uniforms.slice_size];
        }`}},{inputs:[n[0],m]})},gs=e=>({batchDims:e.batch_dims,cacheKey:``})}),vs,ys,bs,xs,Ss=m(()=>{F(),R(),B(),J(),vs=(e,t)=>{if(e.length<3||e.length>4)throw Error(`GatherBlockQuantized requires 3 or 4 inputs.`);let n=L.normalizeAxis(t.quantizeAxis,e[0].dims.length),r=t.blockSize,i=e[0],a=e[2],o=e.length===4?e[3]:void 0;if(a.dims.length!==i.dims.length||!i.dims.map((e,t)=>t===n?Math.ceil(e/r)===a.dims[t]:e===a.dims[t]).reduce((e,t)=>e&&t,!0))throw Error(`Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.`);if(o){if(o.dataType!==i.dataType)throw Error(`Zero point must have the same data type as the input tensor.`);if(o.dims.length!==a.dims.length||!o.dims.map((e,t)=>e===a.dims[t]).reduce((e,t)=>e&&t,!0))throw Error(`Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.`)}},ys=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n.length,a=L.normalizeAxis(t.gatherAxis,i),o=L.normalizeAxis(t.quantizeAxis,i),s=n.slice(0);s.splice(a,1,...r);let c=L.size(s),l=e[2].dataType,u=e[0].dataType===22,d=[{type:12,data:c},{type:12,data:o},{type:12,data:a},{type:12,data:t.blockSize},...U(...e.map((e,t)=>e.dims),s)];return{name:`GatherBlockQuantized`,shaderCache:{hint:`${t.cacheKey};${e.filter((e,t)=>t!==1).map(e=>e.dims.join(`_`)).join(`;`)}`,inputDependencies:Array.from({length:e.length},(e,t)=>`rank`)},getRunData:()=>({outputs:[{dims:s,dataType:l}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:d}),getShaderSource:t=>{let i=K(`data`,e[0].dataType,e[0].dims.length),o=K(`inputIndices`,e[1].dataType,e[1].dims.length),c=K(`scales`,e[2].dataType,e[2].dims.length),d=e.length>3?K(`zeroPoint`,e[3].dataType,e[3].dims.length):void 0,f=q(`output`,l,s.length),p=[i,o,c];return d&&p.push(d),`
    ...
    }`}}},bs=(e,t)=>{let n=e.inputs;vs(n,t),e.compute(ys(e.inputs,t))},xs=e=>z({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Cs,ws,Ts,Es,Ds=m(()=>{F(),R(),B(),J(),Cs=e=>{if(!e||e.length!==2)throw Error(`GatherElements requires 2 inputs.`);if(e[0].dims.length<1)throw Error(`GatherElements requires that the data input be rank >= 1.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},ws=(e,t)=>{let n=e[0].dims,r=e[0].dataType,i=n.length,a=e[1].dims,o=e[1].dataType,s=L.normalizeAxis(t.axis,i),c=n[s],l=a.slice(0),u=L.size(l),d=K(`input`,r,i),f=K(`indicesInput`,o,a.length),p=q(`output`,r,l.length),m=[{type:12,data:u},{type:6,data:c},{type:12,data:s}];return m.push(...U(n,a,l)),{name:`GatherElements`,shaderCache:{inputDependencies:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:m}),getShaderSource:e=>`
  ...
  }`}}},As=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}),js=(e,t)=>{Os(e.inputs),e.compute(ks(e.inputs,t))}}),Ns,Ps,Fs,Is,Ls,Rs,zs,Bs,Vs,Hs,Us,Ws,Gs,Ks,qs=m(()=>{F(),R(),B(),J(),[Ns,Ps,Fs,Is]=[0,1,2,3],Ls=e=>{if(e[0].dims.length!==4)throw Error(`only 4-D tensor is supported.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`input dimensions must be equal to grid dimensions`);if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error(`grid batch size must match input batch size`)},Rs=`
...
`,Hs=(e,t,n)=>`
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${t} {
     ...
     indices[${Ns}] = batch;
     indices[${Ps}] = channel;`+(()=>{switch(n.paddingMode){case`zeros`:return`
          if (r >= 0 && r < H && c >=0 && c < W) {
            indices[${Fs}] = u32(r);
            indices[${Is}] = u32(c);
          } else {
        ...
        `;case`border`:return`
          indices[${Fs}] = u32(clamp(r, 0, H - 1));
          indices[${Is}] = u32(clamp(c, 0, W - 1));
        `;case`reflection`:return`
          indices[${Fs}] = gs_reflect(r, border[1], border[3]);
          indices[${Is}] = gs_reflect(c, border[0], border[2]);
        `;default:throw Error(`padding mode ${n.paddingMode} is not supported`)}})()+`
    return ${e.getByIndices(`indices`)};
  }
`,Us=(e,t,n)=>(()=>{switch(n.mode){case`nearest`:return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${Ns}], indices[${Ps}], border);
        `;case`bilinear`:return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${Ns}], indices[${Ps}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${Ns}], indices[${Ps}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${Ns}], indices[${Ps}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${Ns}], indices[${Ps}], border);
        ...
        `;case`bicubic`:return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${Ns}], indices[${Ps}], border);
            }
          }
        ...
        `;default:throw Error(`mode ${n.mode} is not supported`)}})()+`${e.setByOffset(`global_idx`,`result`)}`,Ws=(e,t)=>{let n=K(`x`,e[0].dataType,e[0].dims.length),r=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],i=K(`grid`,e[1].dataType,r.length,2),a=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format===`NHWC`&&(a=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[Ns,Ps,Fs,Is]=[0,3,1,2]);let o=q(`output`,e[0].dataType,a.length),s=n.type.value,c=[{type:12,data:L.size(a)},...U(e[0].dims,r,a)];return{name:`GridSample`,shaderCache:{hint:`${t.cacheKey}`,inputDependencies:[`type`,`type`]},getRunData:e=>{let t=L.size(a);return{outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)},programUniforms:c}},getShaderSource:e=>`
  ...
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.output_size`)}
      let H_in = i32(uniforms.x_shape[${Fs}]);
      let W_in = i32(uniforms.x_shape[${Is}]);
  ...
  }`}},{inputs:[t,n],outputs:[-1]})[0]},$s=(e,t,n,r,i,a,o,s)=>{let c=a;if(o&&L.size(o.dims)>0){if(r===1)throw Error(`AddBiasReshape is not implemented. Please export your model with packed QKV or KV`);return c=Qs(e,a,o,t,r,n*i,s),c=c.reshape([t,r,n,i]),n===1||r===1?c:e.compute(Y(c,Zs.perm),{inputs:[c],outputs:[-1]})[0]}return a.dims.length===3&&(c=a.reshape([t,r,n,i])),n===1||r===1?c:e.compute(Y(c,Zs.perm),{inputs:[c],outputs:[-1]})[0]},ec=(e,t)=>{let n=Ys(e.inputs,t),r=e.inputs[0],i=Js(e.inputs,1),a=Js(e.inputs,2),o=Js(e.inputs,3),s=Js(e.inputs,4),c=Js(e.inputs,5),l=Js(e.inputs,6),u=Js(e.inputs,7);if(r.dims.length===5)throw Error(`Packed QKV is not implemented`);if(i?.dims.length===5)throw Error(`Packed KV is not implemented`);let d=i&&a&&i.dims.length===4&&a.dims.length===4,f=$s(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,o,0);if(d)return Zr(e,f,i,a,s,void 0,l,u,c,n);if(!i||!a)throw Error(`key and value must be provided`);let p=$s(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,i,o,n.hiddenSize),m=$s(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,a,o,2*n.hiddenSize);Zr(e,f,p,m,s,void 0,l,u,c,n)}}),nc,rc,ic,ac,oc,sc,cc,lc=m(()=>{F(),R(),B(),J(),nc=e=>{if(!e||e.length<1)throw Error(`too few inputs`)},rc=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(e=>n.push(Number(e))),r=n.length),z({numOutputs:r,axis:t.axis,splitSizes:n})},ic=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
      ...
      fn writeBufferData(output_number: u32, indices: ${e[0].type.indices}, global_idx: u32) {
        ${n.join(`
`)}
      }`},oc=(e,t)=>{let n=e[0].dims,r=L.size(n),i=e[0].dataType,a=L.normalizeAxis(t.axis,n.length),o=Array(t.numOutputs),s=K(`input`,i,n.length),c=Array(t.numOutputs),l=[],u=[],d=0,f=[{type:12,data:r}];for(let r=0;r<t.numOutputs;r++){d+=t.splitSizes[r],c[r]=d;let s=n.slice();s[a]=t.splitSizes[r],u.push(s),o[r]=q(`output${r}`,i,s.length),l.push({dims:u[r],dataType:e[0].dataType})}return f.push({type:12,data:c},...U(n,...u)),{name:`Split`,shaderCache:{hint:t.cacheKey,inputDependencies:[`rank`]},getShaderSource:e=>`
  ...
  `}}},vc=(e,t)=>{let n=mc(e.inputs,t);if(e.inputs[0].dims.length===5)throw Error(`Packed QKV is not implemented`);if(e.inputs[1]?.dims.length===5)throw Error(`Packed KV is not implemented`);let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,c=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,u=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=z({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,u*n.headSize,u*n.headSize]}),[f,p,m]=!i&&!a?e.compute(oc([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],h,g;if(t.doRotary){let r=e.compute(_c(n.batchSize,n.sequenceLength,c,l),{inputs:[c,l],outputs:[-1]})[0],i=e.inputs[7],a=e.inputs[8],o=z({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),s=[f,r,i,a],u=[-1];h=e.compute(dc(s,o),{inputs:s,outputs:u})[0],s.splice(0,1,p);let d=z({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});g=e.compute(dc(s,d),{inputs:s,outputs:u})[0]}let _=$s(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?h:f,void 0,0),v=gc(e,t.doRotary?g:p,n),y=gc(e,m,n);Zr(e,_,v,y,void 0,void 0,o,s,void 0,n,c,l)}}),bc,xc,Sc,Cc,wc=m(()=>{F(),R(),Jn(),J(),bc=(e,t,n,r,i,a,o,s)=>{let c=W(a),l=c===1?`f32`:`vec${c}f`,u=c===1?`vec2f`:`mat2x${c}f`,d=i*o,f=64;d===1&&(f=256);let p=[i,o,a/c],m=[i,o,2],h=[`rank`,`type`,`type`],g=[];return g.push(...U(p,m)),e.compute({name:`InstanceNormComputeChannelScaleShift`,shaderCache:{hint:`${c};${s};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:g}),getShaderSource:e=>{let i=K(`x`,t.dataType,3,c),a=[i,K(`scale`,n.dataType,n.dims),K(`bias`,r.dataType,r.dims),q(`output`,1,3,2)];return`
  ...
  }`}},{inputs:[t,n,r],outputs:[-1]})[0]},xc=(e,t,n)=>{let r=t[0].dims,i=r,a=r[0],o=r[1],s=L.sizeFromDimension(r,2),c=W(s),l=L.size(i)/c,u=bc(e,t[0],t[1],t[2],a,s,o,n.epsilon),d=[a,o,s/c],f=[a,o];e.compute({name:`InstanceNormalization`,shaderCache:{hint:`${c}`,inputDependencies:[`type`,`none`]},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:[{type:12,data:l},...U(d,f,d)]}),getShaderSource:e=>{let n=K(`x`,t[0].dataType,d.length,c),r=K(`scale_shift`,1,f.length,2),i=q(`output`,t[0].dataType,d.length,c),a=[n,r,i];return`
  ...
  }`}},{inputs:[t[0],h]})},Cc=(e,t)=>{t.format===`NHWC`?Sc(e,e.inputs,t):xc(e,e.inputs,t)}}),Tc,Ec,Dc,Oc=m(()=>{F(),R(),J(),Tc=e=>{if(!e||e.length<2)throw Error(`layerNorm requires at least 2 inputs.`)},Ec=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,c=L.normalizeAxis(t.axis,i.length),l=L.sizeToDimension(i,c),u=L.sizeFromDimension(i,c),d=L.size(a.dims),f=o?L.size(o.dims):0;if(d!==u||o&&f!==u)throw Error(`Size of X.shape()[axis:] == ${u}.
  ...
  ${t.mainStart()}
    ...
    ${v?`inv_std_output[global_idx] = inv_std_dev`:``};
  }`},b=[{dims:s,dataType:e[0].dataType}];return _&&b.push({dims:p,dataType:1}),v&&b.push({dims:p,dataType:1}),{name:`LayerNormalization`,shaderCache:{hint:`${m};${n};${r}`,inputDependencies:h},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:g}),getShaderSource:y}},Dc=(e,t)=>{Tc(e.inputs),e.compute(Ec(e.inputs,t,e.outputCount))}}),kc,Ac,jc=m(()=>{R(),Ra(),qa(),kc=e=>{if(!e||e.length!==2)throw Error(`MatMul requires 2 inputs.`);if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw Error(`shared dimension does not match.`)},Ac=e=>{kc(e.inputs);let t=Jt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw Error(`Can't use matmul on the given tensors`);let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(La(e.inputs,{activation:``},t));else{let i=t[t.length-2],a=L.size(e.inputs[0].dims.slice(0,-2)),o=L.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let i=e.inputs[0].reshape([1,a,r]),o=e.inputs[1].reshape([1,r,n]),s=[1,a,n],c=[i,o];e.compute(Ka(c,{activation:``},t,s),{inputs:c})}else e.compute(Ka(e.inputs,{activation:``},t))}}}),Mc,Nc,Pc,Fc,Ic,Lc=m(()=>{F(),R(),B(),J(),Mc=(e,t)=>{if(e.length<3||e.length>4)throw Error(`MatMulNBits requires 3 or 4 inputs`);let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw Error(`The last dim of input shape does not match the k value`);let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!L.areEqual(o.dims,[t.n,i,a]))throw Error(`The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize`);let s=e[2].dims;if(L.size(s)!==t.n*i)throw Error(`scales input size error.`);if(e.length===4){let n=e[3].dims,r=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(L.size(n)!==r)throw Error(`zeroPoints input size error.`)}},Nc=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),c=L.size(s),l=e[1].dims[2]/4,u=e[0].dataType,d=W(t.k),f=W(l),p=W(o),m=s.concat([i,o]),h=i>1&&o/p%2==0?2:1,g=L.size(m)/p/h,_=[],v=[c,i,a/d],y=L.convertShape(e[1].dims).slice();y.splice(-1,1,l/f),_.push(...U(v)),_.push(...U(y)),_.push(...U(e[2].dims)),e.length===4&&_.push(...U(L.convertShape(e[3].dims)));let b=[c,i,o/p];return _.push(...U(b)),{name:`MatMulNBits`,shaderCache:{hint:`${t.blockSize};${t.bits};${d};${f};${p};${h};64`,inputDependencies:Array(e.length).fill(`rank`)},getRunData:()=>({outputs:[{dims:m,dataType:u}],dispatchGroup:{x:g},programUniforms:_}),getShaderSource:n=>{let r=v.length,i=K(`a`,e[0].dataType,r,d),a=K(`b`,12,y.length,f),o=K(`scales`,e[2].dataType,e[2].dims.length),s=[i,a,o],c=e.length===4?K(`zero_points`,12,e[3].dims.length):void 0;c&&s.push(c);let u=b.length,m=q(`output`,e[0].dataType,u,p),g=V(e[0].dataType),_=(()=>{switch(d){case 1:return`array<${g}, 8>`;case 2:return`mat4x2<${g}>`;case 4:return`mat2x4<${g}>`;default:throw Error(`${d}-component is not supported.`)}})(),x=Math.floor(32/t.bits),S=Math.floor(x/8),C=()=>{let e=``;for(let n=0;n<S;n++){let r=n*t.bits*4,a=r+t.bits;e+=`
          // reuse a data (pass ${n})
        ...
        }`}}},Fc=(e,t)=>{Mc(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor(`intel`)&&e.adapterInfo.isArchitecture(`gen-12lp`)?e.compute(Pc(e.inputs,t)):e.compute(Nc(e.inputs,t))},Ic=e=>z(e)}),Rc,zc,Bc,Vc,Hc,Uc,Wc,Gc,Kc,qc=m(()=>{F(),R(),J(),Rc=e=>{if(!e||e.length<1)throw Error(`Too few inputs`);if(e[0].dataType!==1&&e[0].dataType!==10)throw Error(`Input type must be float or float16.`);if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw Error(`The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].`)}},zc=(e,t,n)=>{let r=``;for(let i=t-1;i>=0;--i)r+=`
      ...
      `},Bc=(e,t,n)=>{let r=``;for(let i=t-1;i>=0;--i)r+=`
          ...
          `},Uc=(e,t,n)=>{switch(n.mode){case 0:return zc(e,t,n.pads.length);case 1:return Bc(e,t,n.pads.length);case 2:return Vc(e,t,n.pads.length);case 3:return Hc(e,t,n.pads.length);default:throw Error(`Invalid mode`)}},Wc=(e,t)=>{let n=L.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,i=[{type:12,data:L.size(n)},{type:6,data:t.pads}],a=e.length>=3&&e[2].data;return t.mode===0&&i.push({type:a?e[2].dataType:1,data:t.value}),i.push(...U(e[0].dims,n)),{name:`Pad`,shaderCache:{hint:`${t.mode}${a}`,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(L.size(n)/64)},programUniforms:i}),getShaderSource:i=>{let o=q(`output`,e[0].dataType,n.length),s=K(`x`,e[0].dataType,r.length),c=s.type.value,l=Uc(o,r.length,t),u=[{name:`output_size`,type:`u32`},{name:`pads`,type:`i32`,length:t.pads.length}];return t.mode===0&&u.push({name:`constant_value`,type:a?c:`f32`}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Qc=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,$c=e=>`${Qc(e)};${e.countIncludePad}`,el=e=>`${Qc(e)};${e.storageOrder};${e.dilations}`,tl=e=>({format:e.format,autoPad:[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),nl=(e,t,n,r)=>{let[i,a]=Yc(t,r,n),o=K(`x`,t.dataType,t.dims.length),s=o.type.value,c=``;i.countIncludePad?c+=`value /= ${s}(uniforms.kernelSize);`:c+=`value /= ${s}(i32(uniforms.kernelSize) - pad);`;let[l,u,d,f,p]=Xc(a,i);return l.push(...U(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${d};${f};${p}`,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(L.size(a)/64)},programUniforms:l}),getShaderSource:e=>Zc(e,o,t.dims.length,a.length,i,`value += x_val;`,c,0,u,d,f,p)}},rl=e=>{let t=e.count_include_pad!==0,n=tl(e);if(n.ceilMode!==0)throw Error(`using ceil() in shape computation is not yet supported for AveragePool`);let r={countIncludePad:t,...n,cacheKey:``};return{...r,cacheKey:$c(r)}},il=(e,t)=>{Jc(e.inputs),e.compute(nl(`AveragePool`,e.inputs[0],!1,t))},al={autoPad:``,ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ol=e=>{let t=e.format;return{format:t,...al,cacheKey:t}},sl=(e,t)=>{Jc(e.inputs),e.compute(nl(`GlobalAveragePool`,e.inputs[0],!0,t))},cl=(e,t,n,r)=>{let[i,a]=Yc(t,r,n),o=K(`x`,t.dataType,t.dims.length),s=[`rank`],[c,l,u,d,f]=Xc(a,i);return c.push(...U(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${u};${d};${f}`,inputDependencies:s},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(L.size(a)/64)},programUniforms:c}),getShaderSource:e=>Zc(e,o,t.dims.length,a.length,i,`
      value = max(x_val, value);
    `,``,t.dataType===10?-65504:-1e5,l,u,d,f)}},ll=(e,t)=>{Jc(e.inputs),e.compute(cl(`MaxPool`,e.inputs[0],!1,t))},ul=e=>{let t=e.storage_order,n=e.dilations,r=tl(e);if(t!==0)throw Error(`column major storage order is not yet supported for MaxPool`);if(r.ceilMode!==0)throw Error(`using ceil() in shape computation is not yet supported for MaxPool`);let i={storageOrder:t,dilations:n,...r,cacheKey:``};return{...i,cacheKey:el(i)}},dl=e=>{let t=e.format;return{format:t,...al,cacheKey:t}},fl=(e,t)=>{Jc(e.inputs),e.compute(cl(`GlobalMaxPool`,e.inputs[0],!0,t))}}),ml,hl,gl,_l,vl=m(()=>{F(),R(),B(),J(),ml=(e,t)=>{if(e.length<2||e.length>3)throw Error(`DequantizeLinear requires 2 or 3 inputs.`);if(e.length===3&&e[1].dims===e[2].dims)throw Error(`x-scale and x-zero-point must have the same shape.`);if(e.length===3&&e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw Error(`scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.`);if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==e[2].dims.length)throw Error(`scale and zero-point inputs must have the same rank.`);if(!e[1].dims.map((t,n)=>t===e[2].dims[n]).reduce((e,t)=>e&&t,!0))throw Error(`scale and zero-point inputs must have the same shape.`)}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw Error(`blockSize must be set only for block quantization.`);if(!e[1].dims.map((n,r)=>r===t.axis||n===e[0].dims[r]).reduce((e,t)=>e&&t,!0))throw Error(`For block qunatization, scale input shape to match the input shape except for the axis`);if(e[1].dims.length!==e[0].dims.length)throw Error(`For block qunatization the scale input rank must be the same as the x rank.`);let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw Error(`blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].`)}},hl=(e,t)=>{let n=L.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=L.size(a),c=r===3||r===2,l=c?[Math.ceil(L.size(e[0].dims)/4)]:e[0].dims,u=e[1].dims,d=e.length>2?e[2]:void 0,f=d?c?[Math.ceil(L.size(d.dims)/4)]:d.dims:void 0,p=u.length===0||u.length===1&&u[0]===1,m=p===!1&&u.length===1,h=W(s),g=p&&(!c||h===4),_=g?h:1,v=g&&!c?h:1,y=K(`input`,c?12:r,l.length,v),b=K(`scale`,o,u.length),x=d?K(`zero_point`,c?12:r,f.length):void 0,S=q(`output`,o,a.length,_),C=[y,b];x&&C.push(x);let w=[l,u];d&&w.push(f);let ee=[{type:12,data:s/_},{type:12,data:n},{type:12,data:t.blockSize},...U(...w,a)];return{name:`DequantizeLinear`,shaderCache:{hint:t.cacheKey,inputDependencies:x?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/_/64),y:1,z:1},programUniforms:ee})}},gl=(e,t)=>{ml(e.inputs,t),e.compute(hl(e.inputs,t))},_l=e=>z({axis:e.axis,blockSize:e.blockSize})}),yl,bl,xl,Sl=m(()=>{Le(),F(),J(),yl=(e,t,n)=>{if(e===t||e<t&&n<0||e>t&&n>0)throw Error(`Range these inputs' contents are invalid.`)},bl=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...U(a)];return{name:`Range`,shaderCache:{hint:`${r}`},getShaderSource:e=>{let t=q(`output`,r,a.length),n=t.type.value,i=[{name:`outputSize`,type:`u32`},{name:`start`,type:n},{name:`delta`,type:n}];return`
        ${e.registerUniforms(i).declareVariables(t)}
        ${e.mainStart()}
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.outputSize`)}
        output[global_idx] = uniforms.start + ${n}(global_idx) * uniforms.delta;
      }`},getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},xl=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),k.webgpu.validateInputContent&&yl(t,n,r),e.compute(bl(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),Cl,wl,Tl,El,Dl=m(()=>{F(),R(),B(),J(),Cl=(e,t,n,r)=>{if(e!==`none`&&r!==`i32`&&r!==`u32`&&r!==`f32`)throw Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
              ...
              ${i}bitcast<${r}>(oldValue) + (${n})${a}`;case`max`:return r===`i32`||r===`u32`?`atomicMax(&${t}, bitcast<${r}>(${n}));`:`
                ${i}max(bitcast<f32>(oldValue), (${n}))${a}`;case`min`:return r===`i32`||r===`u32`?`atomicMin(&${t}, bitcast<${r}>(${n}));`:`${i}min(bitcast<${r}>(oldValue), (${n}))${a}`;case`mul`:return`${i}(bitcast<${r}>(oldValue) * (${n}))${a}`;default:throw Error(`Reduction ${e} is not supported.`)}},wl=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n,a=Math.ceil(L.sizeToDimension(r,r.length-1)/1),o=r[r.length-1],s=L.sizeFromDimension(n,o),c=[{type:12,data:a},{type:12,data:o},{type:12,data:s},...U(e[1].dims,e[2].dims,i)];return{name:`ScatterND`,shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:n=>{let r=K(`indices`,e[1].dataType,e[1].dims.length),a=K(`updates`,e[2].dataType,e[2].dims.length,1),o=t.reduction!==`none`&&t.reduction!==``?In(`output`,e[0].dataType,i.length):q(`output`,e[0].dataType,i.length,1);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Cl(t.reduction,`output[data_offset + i]`,`value`,o.type.value)}
  }

      }`}}},Tl=e=>z({reduction:e.reduction}),El=(e,t)=>{e.compute(wl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Ol,kl,Al,jl,Ml,Nl,Pl,Fl,Il,Ll,Rl,zl,Bl,Vl,Hl,Ul,Wl,Gl,Kl,ql,Jl=m(()=>{F(),R(),B(),J(),Ol=(e,t)=>{if(e.every(e=>e>0||(()=>{throw Error(`Resize requires scales input values to be positive`)})),e.length>0){if(t.mode===`linear`){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode===`cubic`&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw Error(`Resize requires scales input size to be 2 or 4 for cubic mode`)}},kl=(e,t,n)=>{t.every(e=>e>=0&&e<n||(()=>{throw Error(`Resize requires axes input values to be positive and less than rank`)}));let r=Array(n).fill(1);return t.forEach((t,n)=>r[t]=e[n]),r},Al=(e,t,n,r,i,a)=>{let[o,s,c]=n>10?[1,2,3]:[-1,e.length>1?1:-1,-1],l=e[0].dims.length;if(o>0&&e.length>o&&e[o].dims.length>0)e[o].getFloat32Array().forEach(e=>a.push(e));else if(t.coordinateTransformMode===`tf_crop_and_resize`)throw Error(`Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize`);if(s>0&&e.length>s&&e[s].dims.length===1&&e[s].dims[0]>0){if(e[s].getFloat32Array().forEach(e=>r.push(e)),r.length!==0&&r.length!==l&&n>=18&&r.length!==t.axes.length)throw Error(`Resize requires scales input size to be same as input rank or axes size for opset 18 and up`);Ol(r,t),t.axes.length>0&&kl(r,t.axes,l).forEach((e,t)=>r[t]=e)}if(c>0&&e.length>c&&e[c].dims.length===1&&e[c].dims[0]>0&&(e[c].getBigInt64Array().forEach(e=>i.push(Number(e))),i.length!==0&&i.length!==l&&n>=18&&i.length!==t.axes.length))throw Error(`Resize requires sizes input size to be same as input rank or axes size for opset 18 and up`);if(t.axes.length>0){if(r.length!==0&&r.length!==t.axes.length)throw Error(`Resize requires "scales" input size to be of axes rank when axes attributes is specified`);if(i.length!==0&&i.length!==t.axes.length)throw Error(`Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified`)}if(typeof r<`u`&&typeof i<`u`&&r.length>0&&i.length>l)throw Error(`Resize requires only of scales or sizes to be specified`)},jl=(e,t,n,r)=>`
...
`,Ml=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case`asymmetric`:return`
        ...
        `;case`pytorch_half_pixel`:return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case`half_pixel`:return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw Error(`Coordinate transform mode ${e} is not supported`)}})()+`}`,Nl=(e,t,n)=>`fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {`+(()=>{switch(e){case`round_prefer_ceil`:return`if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }`;case`floor`:return`return floor(xOriginal);`;case`ceil`:return`return ceil(xOriginal);`;case`round_prefer_floor`:return`if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }`;default:if(t<11)return`if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }`;throw Error(`Nearest mode ${e} is not supported`)}})()+`}`,Pl=(e,t,n)=>{let r=Array(n).fill(0).concat(Array(n).fill(1)),i=e.length===0?r:e.slice();return t.length>0?(t.forEach((e,a)=>{r[e]=i[a],r[a+n]=i[t.length+a]}),r):i},Fl=(e,t,n,r)=>{let i=[];if(n.length>0)if(r.length>0){if(e.forEach(e=>i.push(e)),Math.max(...r)>e.length)throw Error(`axes is out of bound`);r.forEach((e,t)=>i[e]=n[t])}else n.forEach(e=>i.push(e));else{if(t.length===0)throw Error(`Resize requires either scales or sizes.`);i=e.map((e,n)=>Math.round(e*t[n]))}return i},Il=(e,t,n)=>{let r=(()=>{switch(n.keepAspectRatioPolicy){case`not_larger`:return n.axes.length>0?Math.min(...n.axes.map(e=>t[e]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case`not_smaller`:return n.axes.length>0?Math.max(...n.axes.map(e=>t[e]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw Error(`Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let i=e.slice();return n.axes.length>0?(n.axes.forEach(e=>t[e]=r),n.axes.forEach(n=>i[n]=Math.round(e[n]*t[n]))):(t.fill(r,0,t.length),i.forEach((e,n)=>i[n]=Math.round(e*t[n]))),i},Ll=(e,t,n,r,i)=>`
...
`:``,Vl=(e,t,n,r,i)=>{let[a,o,s,c]=n.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},Hl=(e,t,n,r,i,a,o,s,c,l)=>{let[u,d]=n.length===2?[0,1]:[2,3],f=e.type.value,p=o=>{let d=o===u?`row`:`col`;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${f} {
    ...
    `},Ul=(e,t,n,r,i)=>{let[a,o,s,c,l]=n.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],u=e.type.value;return`
    ...
    }`},Wl=(e,t,n,r,i,a)=>{let o=e.dims,s=Pl(a,t.axes,o.length),c=Fl(o,r,i,t.axes),l=r.slice();r.length===0&&(l=o.map((e,t)=>e===0?1:c[t]/e),t.keepAspectRatioPolicy!==`stretch`&&(c=Il(o,l,t)));let u=q(`output`,e.dataType,c.length),d=K(`input`,e.dataType,o.length),f=L.size(c),p=o.length===c.length&&o.every((e,t)=>e===c[t]),m=t.coordinateTransformMode===`tf_crop_and_resize`,h=t.extrapolationValue,g=d.type.value;return{name:`Resize`,shaderCache:{hint:`${t.cacheKey}|${n}|${l.length>0?t.mode===`cubic`?l:l.length:``}|${i.length>0?i:``}|${s.length>0?s:``}|${p}|${t.mode===`nearest`?o.length:o}`,inputDependencies:[`rank`]},getShaderSource:e=>`
      ${p?``:`
      ${Ml(t.coordinateTransformMode,g)};
      ${(()=>{switch(t.mode){case`nearest`:return`
              ${zl(d,o)};
              ${Nl(t.nearestMode,n,g)};
              ${Rl(d,u,o,c,l.length,s.length,m)};
              `;case`linear`:return`
              ${Ll(u,o,c,l.length,s.length)};
              ${(()=>{if(o.length===2||o.length===4)return`${Vl(d,u,o,m,h)}`;if(o.length===3||o.length===5)return`${Ul(d,u,o,m,h)}`;throw Error(`Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.`)})()};
            `;case`cubic`:return`
            ${(()=>{if(o.length===2||o.length===4)return`${Hl(d,u,o,c,l,s,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error(`Cubic mode only supports input dims 2 and 4 are supported in linear mode.`)})()};
...
`}
      ...
      }`},y=[{dims:s,dataType:e[0].dataType}];return n>1&&y.push({dims:u,dataType:1}),n>2&&y.push({dims:u,dataType:1}),n>3&&y.push({dims:a,dataType:e[0].dataType}),{name:`SkipLayerNormalization`,shaderCache:{hint:`${g};${p};${m};${h}`,inputDependencies:e.map((e,t)=>`type`)},getShaderSource:v,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(c/l)},programUniforms:_})}},Zl=(e,t)=>{Yl(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(Xl(e.inputs,t,e.outputCount,!1),{outputs:n})}}),$l,eu,tu,nu,ru,iu,au,ou,su=m(()=>{F(),R(),B(),J(),$l=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw Error(`axes, starts and ends must have the same length`)}else if(t.starts.length!==t.ends.length)throw Error(`starts and ends must have the same length`);e.slice(1).forEach((t,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw Error(`Input ${n} must be an array of int32 or int64`)})},eu=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(e=>n.push(Number(e)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(e=>n.push(Number(e)));else throw Error(`Input ${t} must be an array of int32 or int64`);return n},tu=(e,t)=>{if(e.length>1){let t=eu(e,1),n=eu(e,2),r=eu(e,3);return r.length===0&&(r=[...Array(e[0].dims.length).keys()]),z({starts:t,ends:n,axes:r})}return t},nu=(e,t,n,r,i)=>{let a=e;return e<0&&(a+=n[r[t]]),i[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},ru=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`},{inputs:[c],outputs:[s?-1:0]})[0];s&&e.compute(Y(x,l),{inputs:[x]})},uu=(e,t)=>{cu(e.inputs),lu(e,t)},du=e=>z({axis:e.axis})}),pu,mu,hu,gu,_u,vu=m(()=>{F(),R(),J(),pu=e=>Array.from(e.getBigInt64Array(),Number),mu=e=>{if(!e||e.length!==2)throw Error(`Tile requires 2 inputs.`);if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw Error(`Tile only support float, float16, int32, and uint32 data types`);if(e[1].dataType!==7)throw Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw Error("Tile `repeats` input should be 1-D");if(pu(e[1]).length!==e[0].dims.length)throw Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},hu=(e,t)=>{let n=[];for(let r=0;r<e.length;++r)n.push(e[r]*t[r]);return n},gu=(e,t)=>{let n=e[0].dims,r=t??pu(e[1]),i=hu(n,r),a=L.size(i),o=e[0].dataType,s=K(`input`,o,n.length),c=q(`output`,o,i.length);return{name:`Tile`,shaderCache:{hint:`${r}`,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},...U(e[0].dims,i)]}),getShaderSource:e=>`
      ...
      ${c.setByOffset(`global_idx`,s.getByIndices(`input_indices`))}
    }`}},_u=e=>{mu(e.inputs),e.compute(gu(e.inputs),{inputs:[0]})}}),yu,bu,xu,Su=m(()=>{F(),R(),J(),yu=(e,t,n,r,i)=>{let a=q(`output_data`,i,n.length,4),o=K(`a_data`,t[1].dataType,t[1].dims.length,4),s=K(`b_data`,t[2].dataType,t[2].dims.length,4),c=K(`c_data`,t[0].dataType,t[0].dims.length,4),l,u=(e,t,n)=>`select(${t}, ${e}, ${n})`;if(!r)l=a.setByOffset(`global_idx`,u(o.getByOffset(`global_idx`),s.getByOffset(`global_idx`),c.getByOffset(`global_idx`)));else{let e=(e,t,n=``)=>{let r=`a_data[index_a${t}][component_a${t}]`,i=`b_data[index_b${t}][component_b${t}]`,l=`bool(c_data[index_c${t}] & (0xffu << (component_c${t} * 8)))`;return`
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
        ${l}
      }`},bu=e=>{let t=e[1].dims,n=e[2].dims,r=e[0].dims,i=e[1].dataType,a=!(L.areEqual(t,n)&&L.areEqual(n,r)),o=t,s=L.size(t);if(a){let e=Jt.calcShape(Jt.calcShape(t,n,!1),r,!1);if(!e)throw Error(`Can't perform where op on the given tensors`);o=e,s=L.size(o)}let c=Math.ceil(s/4);return{name:`Where`,shaderCache:{inputDependencies:[`rank`,`rank`,`rank`]},getShaderSource:t=>yu(t,e,o,a,i),getRunData:()=>({outputs:[{dims:o,dataType:i}],dispatchGroup:{x:Math.ceil(s/64/4)},programUniforms:[{type:12,data:c},...U(r,t,n,o)]})}},xu=e=>{e.compute(bu(e.inputs))}}),Cu,wu=m(()=>{Gr(),ei(),ai(),li(),ia(),va(),Ta(),yo(),jo(),Fo(),Vo(),$o(),as(),cs(),ps(),_s(),Ss(),Ds(),Ms(),qs(),yc(),wc(),Oc(),jc(),Lc(),tc(),qc(),pl(),vl(),Sl(),Dl(),Br(),Jl(),pc(),Ql(),su(),fu(),lc(),vu(),Jn(),ea(),Su(),Cu=new Map([[`Abs`,[di]],[`Acos`,[fi]],[`Acosh`,[pi]],[`Add`,[ca]],[`ArgMax`,[Ur,Wr]],[`ArgMin`,[Hr,Wr]],[`Asin`,[mi]],[`Asinh`,[hi]],[`Atan`,[gi]],[`Atanh`,[_i]],[`Attention`,[$r]],[`AveragePool`,[il,rl]],[`BatchNormalization`,[ii]],[`BiasAdd`,[ci]],[`BiasSplitGelu`,[ra]],[`Cast`,[yi,vi]],[`Ceil`,[Si]],[`Clip`,[xi]],[`Concat`,[Ca,wa]],[`Conv`,[vo,mo]],[`ConvTranspose`,[Ao,Eo]],[`Cos`,[Ci]],[`Cosh`,[wi]],[`CumSum`,[No,Po]],[`DepthToSpace`,[zo,Bo]],[`DequantizeLinear`,[gl,_l]],[`Div`,[la]],[`Einsum`,[Zo,Qo]],[`Elu`,[Ei,Ti]],[`Equal`,[ua]],[`Erf`,[Oi]],[`Exp`,[ki]],[`Expand`,[is]],[`FastGelu`,[ss]],[`Floor`,[Ai]],[`FusedConv`,[vo,mo]],[`Gather`,[fs,ds]],[`GatherElements`,[Es,Ts]],[`GatherBlockQuantized`,[bs,xs]],[`GatherND`,[hs,gs]],[`Gelu`,[ji]],[`Gemm`,[js,As]],[`GlobalAveragePool`,[sl,ol]],[`GlobalMaxPool`,[fl,dl]],[`Greater`,[ma]],[`GreaterOrEqual`,[ga]],[`GridSample`,[Gs,Ks]],[`GroupQueryAttention`,[vc]],[`HardSigmoid`,[zi,Ri]],[`InstanceNormalization`,[Cc]],[`LayerNormalization`,[Dc]],[`LeakyRelu`,[Mi,Ti]],[`Less`,[ha]],[`LessOrEqual`,[_a]],[`Log`,[Xi]],[`MatMul`,[Ac]],[`MatMulNBits`,[Fc,Ic]],[`MaxPool`,[ll,ul]],[`Mul`,[da]],[`MultiHeadAttention`,[ec,Xs]],[`Neg`,[Pi]],[`Not`,[Ni]],[`Pad`,[Kc]],[`Pow`,[fa]],[`QuickGelu`,[$i,Ti]],[`Range`,[xl]],[`Reciprocal`,[Fi]],[`ReduceMin`,[Fr]],[`ReduceMean`,[Ar]],[`ReduceMax`,[Pr]],[`ReduceSum`,[Lr]],[`ReduceProd`,[Ir]],[`ReduceL1`,[jr]],[`ReduceL2`,[Mr]],[`ReduceLogSum`,[zr]],[`ReduceLogSumExp`,[Nr]],[`ReduceSumSquare`,[Rr]],[`Relu`,[Ii]],[`Resize`,[Kl,ql]],[`RotaryEmbedding`,[fc]],[`ScatterND`,[El,Tl]],[`Sigmoid`,[Li]],[`Sin`,[Bi]],[`Sinh`,[Vi]],[`Slice`,[au,ou]],[`SkipLayerNormalization`,[Zl]],[`Split`,[sc,cc]],[`Sqrt`,[Hi]],[`Softmax`,[uu,du]],[`Sub`,[pa]],[`Tan`,[Ui]],[`Tanh`,[Gi]],[`ThresholdedRelu`,[Yi,Ti]],[`Tile`,[_u]],[`Transpose`,[Kn,qn]],[`Where`,[xu]]])}),Tu,Eu=m(()=>{Le(),Kt(),J(),Tu=class{constructor(e){this.backend=e,this.repo=new Map,this.attributesBound=!1}getArtifact(e){return this.repo.get(e)}setArtifact(e,t){this.repo.set(e,t)}run(e,t,n,r,i){we(e.programInfo.name);let a=this.backend.device,o=this.backend.getComputePassEncoder();this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2);let s=[];for(let e of t)s.push({binding:s.length,resource:{buffer:e.buffer}});for(let e of n)s.push({binding:s.length,resource:{buffer:e.buffer}});i&&s.push({binding:s.length,resource:i});let c=a.createBindGroup({layout:e.computePipeline.getBindGroupLayout(0),entries:s,label:e.programInfo.name});if(this.backend.sessionStatus===`capturing`){let t={kernelId:this.backend.currentKernelId,computePipeline:e.computePipeline,bindGroup:c,dispatchGroup:r};this.backend.capturedCommandList.get(this.backend.currentSessionId).push(t)}o.setPipeline(e.computePipeline),o.setBindGroup(0,c),o.dispatchWorkgroups(...r),this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2+1),this.backend.pendingDispatchNumber++,(this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber||this.backend.queryType===`at-passes`)&&this.backend.endComputePass(),this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber&&this.backend.flush(),Te(e.programInfo.name)}dispose(){}build(e,t){we(e.name);let n=this.backend.device,r=[];[{feature:`shader-f16`,extension:`f16`},{feature:`subgroups`,extension:`subgroups`}].forEach(e=>{n.features.has(e.feature)&&r.push(`enable ${e.extension};`)});let i=zn(t,this.backend.device.limits),a=e.getShaderSource(i),o=`${r.join(`
`)}
${i.additionalImplementations}
${a}`,s=n.createShaderModule({code:o,label:e.name});I(`verbose`,()=>`[WebGPU] ${e.name} shader code: ${o}`);let c=n.createComputePipeline({compute:{module:s,entryPoint:`main`},layout:`auto`,label:e.name});return Te(e.name),{programInfo:e,computePipeline:c,uniformVariablesInfo:i.variablesInfo}}normalizeDispatchGroupSize(e){let t=typeof e==`number`?e:e.x,n=typeof e==`number`?1:e.y||1,r=typeof e==`number`?1:e.z||1,i=this.backend.device.limits.maxComputeWorkgroupsPerDimension;if(t<=i&&n<=i&&r<=i)return[t,n,r];let a=t*n*r,o=Math.ceil(Math.sqrt(a));if(o>i){if(o=Math.ceil(Math.cbrt(a)),o>i)throw Error(`Total dispatch size exceeds WebGPU maximum.`);return[o,o,o]}return[o,o,1]}}}),Du={};h(Du,{WebGpuBackend:()=>ju});var Ou,ku,Au,ju,Mu=m(()=>{Le(),F(),Kt(),en(),On(),wu(),Eu(),Ou=(e,t)=>{if(t.length!==e.length)throw Error(`inputDependencies length ${t.length} is not equal to inputTensors length ${e.length}.`);let n=[];for(let r=0;r<e.length;++r){let i=e[r].dataType;switch(t[r]){case`none`:n.push(``);break;case`type`:n.push(`${i}`);break;case`rank`:{let t=e[r].dims.length;n.push(`${i};${t}`);break}case`dims`:{let t=e[r].dims.join(`,`);n.push(`${i};${t}`);break}default:throw Error(`unsupported input dependency: ${t[r]}`)}}return n.join(`|`)},ku=(e,t,n)=>{let r=e.name;return e.shaderCache?.hint&&(r+=`[`+e.shaderCache.hint+`]`),r+=`:`+n+`:${Ou(t,e.shaderCache?.inputDependencies??Array(t.length).fill(`dims`))}`,r},Au=class{constructor(e){e&&(this.architecture=e.architecture,this.vendor=e.vendor)}isArchitecture(e){return this.architecture===e}isVendor(e){return this.vendor===e}},ju=class{constructor(){this.currentSessionId=null,this.currentKernelId=null,this.commandEncoder=null,this.computePassEncoder=null,this.maxDispatchNumber=16,this.pendingDispatchNumber=0,this.pendingKernels=[],this.pendingQueries=new Map,this.sessionStatus=`default`,this.capturedCommandList=new Map,this.capturedPendingKernels=new Map,this.sessionExternalDataMapping=new Map}get currentKernelCustomData(){if(this.currentKernelId===null)throw Error(`currentKernelCustomData(): currentKernelId is null. (should not happen)`);let e=this.kernelCustomData.get(this.currentKernelId);return e||(e={},this.kernelCustomData.set(this.currentKernelId,e)),e}async initialize(e,t){this.env=e;let n=[],r={requiredLimits:{maxComputeWorkgroupStorageSize:t.limits.maxComputeWorkgroupStorageSize,maxComputeWorkgroupsPerDimension:t.limits.maxComputeWorkgroupsPerDimension,maxStorageBufferBindingSize:t.limits.maxStorageBufferBindingSize,maxBufferSize:t.limits.maxBufferSize,maxComputeInvocationsPerWorkgroup:t.limits.maxComputeInvocationsPerWorkgroup,maxComputeWorkgroupSizeX:t.limits.maxComputeWorkgroupSizeX,maxComputeWorkgroupSizeY:t.limits.maxComputeWorkgroupSizeY,maxComputeWorkgroupSizeZ:t.limits.maxComputeWorkgroupSizeZ},requiredFeatures:n},i=e=>t.features.has(e)&&n.push(e)&&!0;i(`chromium-experimental-timestamp-query-inside-passes`)||i(`timestamp-query`),i(`shader-f16`),i(`subgroups`),this.device=await t.requestDevice(r);let a=t,o=t.info??(typeof a.requestAdapterInfo==`function`?await a.requestAdapterInfo():void 0);this.adapterInfo=new Au(o),this.gpuDataManager=Dn(this),this.programManager=new Tu(this),this.kernels=new Map,this.kernelPersistentData=new Map,this.kernelCustomData=new Map,Wt(e.logLevel,!!e.debug),this.device.onuncapturederror=e=>{e.error instanceof GPUValidationError&&console.error(`An uncaught WebGPU validation error was raised: ${e.error.message}`)},Object.defineProperty(this.env.webgpu,"device",{value:this.device,writable:!1,enumerable:!0,configurable:!0}),Object.defineProperty(this.env.webgpu,"adapter",{value:t,writable:!1,enumerable:!0,configurable:!1}),this.setQueryType()}dispose(){typeof this.querySet<`u`&&this.querySet.destroy(),this.gpuDataManager.dispose(),this.device&&this.env?.webgpu&&this.device.lost.then(()=>{delete this.env.webgpu.device})}getCommandEncoder(){return this.commandEncoder||=this.device.createCommandEncoder(),this.commandEncoder}getComputePassEncoder(){if(!this.computePassEncoder){let e=this.getCommandEncoder(),t={};this.queryType===`at-passes`&&(t.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:this.pendingDispatchNumber*2,endOfPassWriteIndex:this.pendingDispatchNumber*2+1}),this.computePassEncoder=e.beginComputePass(t)}return this.computePassEncoder}endComputePass(){this.computePassEncoder&&=(this.computePassEncoder.end(),null)}flush(){if(!this.commandEncoder)return;we(),this.endComputePass();let e;this.queryType!==`none`&&(this.commandEncoder.resolveQuerySet(this.querySet,0,this.pendingDispatchNumber*2,this.queryResolveBuffer,0),e=this.device.createBuffer({size:this.pendingDispatchNumber*2*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.pendingQueries.set(e,this.pendingKernels),this.pendingKernels=[],this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer,0,e,0,this.pendingDispatchNumber*2*8)),this.device.queue.submit([this.commandEncoder.finish()]),this.gpuDataManager.refreshPendingBuffers(),this.commandEncoder=null,this.pendingDispatchNumber=0,this.queryType!==`none`&&e.mapAsync(GPUMapMode.READ).then(()=>{let t=new BigUint64Array(e.getMappedRange()),n=this.pendingQueries.get(e);for(let e=0;e<t.length/2;e++){let r=n[e],i=r.kernelId,a=this.kernels.get(i),o=a.kernelType,s=a.kernelName,c=r.programName,l=r.inputTensorViews,u=r.outputTensorViews,d=t[e*2],f=t[e*2+1];typeof this.queryTimeBase>`u`&&(this.queryTimeBase=d);let p=Number(d-this.queryTimeBase),m=Number(f-this.queryTimeBase);if(!Number.isSafeInteger(p)||!Number.isSafeInteger(m))throw RangeError(`incorrect timestamp range`);if(this.env.webgpu.profiling?.ondata)this.env.webgpu.profiling.ondata({version:1,inputsMetadata:l.map(e=>({dims:e.dims,dataType:jt(e.dataType)})),outputsMetadata:u.map(e=>({dims:e.dims,dataType:jt(e.dataType)})),kernelId:i,kernelType:o,kernelName:s,programName:c,startTime:p,endTime:m});else{let e=``;l.forEach((t,n)=>{e+=`input[${n}]: [${t.dims}] | ${jt(t.dataType)}, `});let t=``;u.forEach((e,n)=>{t+=`output[${n}]: [${e.dims}] | ${jt(e.dataType)}, `}),console.log(`[profiling] kernel "${i}|${o}|${s}|${c}" ${e}${t}start time: ${p} ns, execution time: ${m-p} ns`)}Se(`GPU`,`${c}::${d}::${f}`)}e.unmap(),this.pendingQueries.delete(e)}),Te()}run(e,t,n,r,i,a){we(e.name);let o=[];for(let e=0;e<t.length;++e){let n=t[e].data;if(n===0)continue;let r=this.gpuDataManager.get(n);if(!r)throw Error(`no GPU data for input: ${n}`);o.push(r)}let{outputs:s,dispatchGroup:c,programUniforms:l}=e.getRunData(t),u=n.length===0?s.map((e,t)=>t):n;if(u.length!==s.length)throw Error(`Output size ${u.length} must be equal to ${s.length}.`);let d=[],f=[];for(let e=0;e<s.length;++e){if(!Number.isInteger(u[e])||u[e]<-3||u[e]>=a)throw Error(`Invalid output index: ${u[e]}`);if(u[e]===-3)continue;let t=u[e]===-1,n=u[e]===-2,o=t||n?i(s[e].dataType,s[e].dims):r(u[e],s[e].dataType,s[e].dims);if(d.push(o),o.data===0)continue;let c=this.gpuDataManager.get(o.data);if(!c)throw Error(`no GPU data for output: ${o.data}`);if(t&&this.temporaryData.push(c),n){let e=this.kernelPersistentData.get(this.currentKernelId);e||(e=[],this.kernelPersistentData.set(this.currentKernelId,e)),e.push(c)}f.push(c)}if(o.length!==t.length||f.length!==d.length){if(f.length===0)return Te(e.name),d;throw Error(`Program ${e.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`)}let p;if(l){let e=0,t=[];l.forEach(n=>{let r=typeof n.data==`number`?[n.data]:n.data;if(r.length===0)return;let i=n.type===10?2:4,a,o;n.type===10?(o=r.length>4?16:r.length>2?8:r.length*i,a=r.length>4?16:i*r.length):(o=r.length<=2?r.length*i:16,a=16),e=Math.ceil(e/o)*o,t.push(e);let s=n.type===10?8:4;e+=r.length>4?Math.ceil(r.length/s)*a:r.length*i}),e=Math.ceil(e/16)*16;let n=new ArrayBuffer(e);l.forEach((e,r)=>{let i=t[r],a=typeof e.data==`number`?[e.data]:e.data;if(e.type===6)new Int32Array(n,i,a.length).set(a);else if(e.type===12)new Uint32Array(n,i,a.length).set(a);else if(e.type===10)new Uint16Array(n,i,a.length).set(a);else if(e.type===1)new Float32Array(n,i,a.length).set(a);else throw Error(`Unsupported uniform type: ${jt(e.type)}`)});let r=this.gpuDataManager.create(e,GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM);this.device.queue.writeBuffer(r.buffer,0,n,0,e),this.gpuDataManager.release(r.id),p={offset:0,size:e,buffer:r.buffer}}let m=this.programManager.normalizeDispatchGroupSize(c),h=m[1]===1&&m[2]===1,g=ku(e,t,h),_=this.programManager.getArtifact(g);if(_||(_=this.programManager.build(e,m),this.programManager.setArtifact(g,_),I(`info`,()=>`[artifact] key: ${g}, programName: ${e.name}`)),l&&_.uniformVariablesInfo){if(l.length!==_.uniformVariablesInfo.length)throw Error(`Uniform variables count mismatch: expect ${_.uniformVariablesInfo.length}, got ${l.length} in program "${_.programInfo.name}".`);for(let e=0;e<l.length;e++){let t=l[e],n=t.type,r=typeof t.data==`number`?1:t.data.length,[i,a]=_.uniformVariablesInfo[e];if(n!==i||r!==a)throw Error(`Uniform variable ${e} mismatch: expect type ${i} with size ${a}, got type ${n} with size ${r} in program "${_.programInfo.name}".`)}}if(I(`info`,()=>`[ProgramManager] run "${e.name}" (key=${g}) with ${m[0]}x${m[1]}x${m[2]}`),this.queryType!==`none`||this.sessionStatus===`capturing`){let e={kernelId:this.currentKernelId,programName:_.programInfo.name,inputTensorViews:t,outputTensorViews:d};this.pendingKernels.push(e),this.sessionStatus===`capturing`&&this.capturedPendingKernels.get(this.currentSessionId).push(e)}return this.programManager.run(_,o,f,m,p),Te(e.name),d}upload(e,t){this.gpuDataManager.upload(e,t)}memcpy(e,t){this.gpuDataManager.memcpy(e,t)}async download(e,t){await this.gpuDataManager.download(e,t)}alloc(e){return this.gpuDataManager.create(e).id}free(e){return this.gpuDataManager.release(e)}createKernel(e,t,n,r){let i=Cu.get(e);if(!i)throw Error(`kernel not implemented: ${e}`);let a={kernelType:e,kernelName:r,kernelEntry:i[0],attributes:[i[1],n]};this.kernels.set(t,a)}releaseKernel(e){let t=this.kernelPersistentData.get(e);if(t){for(let e of t)this.gpuDataManager.release(e.id);this.kernelPersistentData.delete(e)}this.kernelCustomData.delete(e),this.kernels.delete(e)}computeKernel(e,t,n){let r=this.kernels.get(e);if(!r)throw Error(`kernel not created: ${e}`);let i=r.kernelType,a=r.kernelName,o=r.kernelEntry,s=r.attributes;if(this.currentKernelId!==null)throw Error(`kernel "[${i}] ${a}" is not allowed to be called recursively`);this.currentKernelId=e,s[0]&&=(s[1]=s[0](s[1]),void 0),I(`info`,()=>`[WebGPU] Start to run kernel "[${i}] ${a}"...`);let c=this.env.debug;this.temporaryData=[];try{return c&&this.device.pushErrorScope(`validation`),o(t,s[1]),0}catch(e){return n.push(Promise.resolve(`[WebGPU] Kernel "[${i}] ${a}" failed. ${e}`)),1}finally{c&&n.push(this.device.popErrorScope().then(e=>e?`GPU validation error for kernel "[${i}] ${a}": ${e.message}`:null));for(let e of this.temporaryData)this.gpuDataManager.release(e.id);this.temporaryData=[],this.currentKernelId=null}}registerBuffer(e,t,n,r){let i=this.sessionExternalDataMapping.get(e);i||(i=new Map,this.sessionExternalDataMapping.set(e,i));let a=i.get(t),o=this.gpuDataManager.registerExternalBuffer(n,r,a);return i.set(t,[o,n]),o}unregisterBuffers(e){let t=this.sessionExternalDataMapping.get(e);t&&(t.forEach(e=>this.gpuDataManager.unregisterExternalBuffer(e[0])),this.sessionExternalDataMapping.delete(e))}getBuffer(e){let t=this.gpuDataManager.get(e);if(!t)throw Error(`no GPU data for buffer: ${e}`);return t.buffer}createDownloader(e,t,n){return async()=>{let r=await Tn(this,e,t);return $t(r.buffer,n)}}writeTimestamp(e){this.queryType===`inside-passes`&&this.computePassEncoder.writeTimestamp(this.querySet,e)}setQueryType(){this.queryType=`none`,(this.env.webgpu.profiling?.mode==="default"||(typeof this.env.trace>`u`?this.env.wasm.trace:this.env.trace))&&(this.device.features.has(`chromium-experimental-timestamp-query-inside-passes`)?this.queryType=`inside-passes`:this.device.features.has(`timestamp-query`)&&(this.queryType=`at-passes`),this.queryType!==`none`&&typeof this.querySet>`u`&&(this.querySet=this.device.createQuerySet({type:`timestamp`,count:this.maxDispatchNumber*2}),this.queryResolveBuffer=this.device.createBuffer({size:this.maxDispatchNumber*2*8,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE})))}captureBegin(){I(`info`,`captureBegin`),this.capturedCommandList.get(this.currentSessionId)||this.capturedCommandList.set(this.currentSessionId,[]),this.capturedPendingKernels.get(this.currentSessionId)||this.capturedPendingKernels.set(this.currentSessionId,[]),this.flush(),this.sessionStatus=`capturing`}captureEnd(){I(`info`,`captureEnd`),this.flush(),this.sessionStatus=`default`}replay(){I(`info`,`replay`),this.sessionStatus=`replaying`;let e=this.capturedCommandList.get(this.currentSessionId),t=this.capturedPendingKernels.get(this.currentSessionId),n=e.length;this.pendingKernels=[];for(let r=0;r<n;r++){let n=this.getComputePassEncoder(),i=e[r];this.writeTimestamp(this.pendingDispatchNumber*2),n.setPipeline(i.computePipeline),n.setBindGroup(0,i.bindGroup),n.dispatchWorkgroups(...i.dispatchGroup),this.writeTimestamp(this.pendingDispatchNumber*2+1),this.pendingDispatchNumber++,this.queryType!==`none`&&this.pendingKernels.push(t[r]),(this.pendingDispatchNumber>=this.maxDispatchNumber||this.queryType===`at-passes`)&&this.endComputePass(),this.pendingDispatchNumber>=this.maxDispatchNumber&&this.flush()}this.flush(),this.sessionStatus=`default`}onCreateSession(){this.gpuDataManager.onCreateSession()}onReleaseSession(e){this.unregisterBuffers(e),this.capturedCommandList.has(e)&&this.capturedCommandList.delete(e),this.capturedPendingKernels.has(e)&&this.capturedPendingKernels.delete(e),this.gpuDataManager.onReleaseSession(e)}onRunStart(e){this.currentSessionId=e,this.setQueryType()}}}),Nu={};h(Nu,{init:()=>Iu});var Pu,Fu,Iu,Lu=m(()=>{F(),Kt(),R(),_n(),Pu=class e{constructor(e,t,n,r){this.module=e,this.dataType=t,this.data=n,this.dims=r}getFloat32Array(){if(this.dataType!==1)throw Error(`Invalid data type`);let e=L.size(this.dims);return e===0?new Float32Array:new Float32Array(this.module.HEAP8.buffer,this.data,e)}getBigInt64Array(){if(this.dataType!==7)throw Error(`Invalid data type`);let e=L.size(this.dims);return e===0?new BigInt64Array:new BigInt64Array(this.module.HEAP8.buffer,this.data,e)}getInt32Array(){if(this.dataType!==6)throw Error(`Invalid data type`);let e=L.size(this.dims);return e===0?new Int32Array:new Int32Array(this.module.HEAP8.buffer,this.data,e)}getUint16Array(){if(this.dataType!==10&&this.dataType!==4)throw Error(`Invalid data type`);let e=L.size(this.dims);return e===0?new Uint16Array:new Uint16Array(this.module.HEAP8.buffer,this.data,e)}reshape(t){if(L.size(t)!==L.size(this.dims))throw Error(`Invalid new shape`);return new e(this.module,this.dataType,this.data,t)}},Fu=class{constructor(e,t,n){this.module=e,this.backend=t,this.customDataOffset=0,this.customDataSize=0,this.adapterInfo=t.adapterInfo;let r=e.PTR_SIZE,i=n/e.PTR_SIZE,a=r===4?`i32`:`i64`;this.opKernelContext=Number(e.getValue(r*i++,a));let o=Number(e.getValue(r*i++,a));this.outputCount=Number(e.getValue(r*i++,a)),this.customDataOffset=Number(e.getValue(r*i++,`*`)),this.customDataSize=Number(e.getValue(r*i++,a));let s=[];for(let t=0;t<o;t++){let t=Number(e.getValue(r*i++,a)),n=Number(e.getValue(r*i++,`*`)),o=Number(e.getValue(r*i++,a)),c=[];for(let t=0;t<o;t++)c.push(Number(e.getValue(r*i++,a)));s.push(new Pu(e,t,n,c))}this.inputs=s}get kernelCustomData(){return this.backend.currentKernelCustomData}get customDataBuffer(){return this.module.HEAPU8.subarray(this.customDataOffset,this.customDataOffset+this.customDataSize)}compute(e,t){let n=t?.inputs?.map(e=>typeof e==`number`?this.inputs[e]:e)??this.inputs,r=t?.outputs??[];return this.backend.run(e,n,r,(e,t,n)=>new Pu(this.module,t,this.output(e,n),n),(e,t)=>{let n=Mt(e,t);if(!n)throw Error(`Unsupported data type: ${e}`);let r=n>0?this.backend.gpuDataManager.create(n).id:0;return new Pu(this.module,e,r,t)},this.outputCount)}output(e,t){let n=this.module.stackSave();try{let n=this.module.PTR_SIZE,r=n===4?`i32`:`i64`,i=this.module.stackAlloc((1+t.length)*n);this.module.setValue(i,t.length,r);for(let e=0;e<t.length;e++)this.module.setValue(i+n*(e+1),t[e],r);return this.module._JsepOutput(this.opKernelContext,e,i)}catch(n){throw Error(`Failed to generate kernel's output[${e}] with dims [${t}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${n}`)}finally{this.module.stackRestore(n)}}},Iu=async(e,t,n,r)=>{let i=t.jsepInit;if(!i)throw Error(`Failed to initialize JSEP. The WebAssembly module is not built with JSEP support.`);if(e===`webgpu`){let e=(Mu(),_(Du)).WebGpuBackend,a=new e;await a.initialize(n,r),i(`webgpu`,[a,e=>a.alloc(Number(e)),e=>a.free(e),(e,n,r,i=!1)=>{if(i)I(`verbose`,()=>`[WebGPU] jsepCopyGpuToGpu: src=${Number(e)}, dst=${Number(n)}, size=${Number(r)}`),a.memcpy(Number(e),Number(n));else{I(`verbose`,()=>`[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(e)}, gpuDataId=${Number(n)}, size=${Number(r)}`);let i=t.HEAPU8.subarray(Number(e>>>0),Number(e>>>0)+Number(r));a.upload(Number(n),i)}},async(e,n,r)=>{I(`verbose`,()=>`[WebGPU] jsepCopyGpuToCpu: gpuDataId=${e}, dataOffset=${n}, size=${r}`),await a.download(Number(e),()=>t.HEAPU8.subarray(Number(n)>>>0,Number(n+r)>>>0))},(e,n,r)=>a.createKernel(e,Number(n),r,t.UTF8ToString(t._JsepGetNodeName(Number(n)))),e=>a.releaseKernel(e),(e,n,r,i)=>{I(`verbose`,()=>`[WebGPU] jsepRun: sessionHandle=${r}, kernel=${e}, contextDataOffset=${n}`);let o=new Fu(t,a,Number(n));return a.computeKernel(Number(e),o,i)},()=>a.captureBegin(),()=>a.captureEnd(),()=>a.replay()])}else{let e=new gn(n);i(`webnn`,[e,()=>e.reserveTensorId(),t=>e.releaseTensorId(t),async(t,n,r,i,a)=>e.ensureTensor(t,n,r,i,a),(t,n)=>{e.uploadTensor(t,n)},async(t,n)=>e.downloadTensor(t,n),(t,n)=>e.registerMLContext(t,n),!!n.trace])}}}),Ru,zu,Bu,Vu,Hu,Uu,Wu,Gu,Ku,qu,Ju,Yu,Xu,Zu=m(()=>{Le(),St(),kt(),F(),_t(),bt(),zt(),Ru=(e,t)=>{N()._OrtInit(e,t)!==0&&P(`Can't initialize onnxruntime.`)},zu=async e=>{Ru(e.wasm.numThreads,Pt(e.logLevel))},Bu=async(e,t)=>{N().asyncInit?.();let n=e.webgpu.adapter;if(t===`webgpu`){if(typeof navigator>`u`||!navigator.gpu)throw Error(`WebGPU is not supported in current environment`);if(n){if(typeof n.limits!=`object`||typeof n.features!=`object`||typeof n.requestDevice!=`function`)throw Error("Invalid GPU adapter set in `env.webgpu.adapter`. It must be a GPUAdapter object.")}else{let t=e.webgpu.powerPreference;if(t!==void 0&&t!==`low-power`&&t!==`high-performance`)throw Error(`Invalid powerPreference setting: "${t}"`);let r=e.webgpu.forceFallbackAdapter;if(r!==void 0&&typeof r!=`boolean`)throw Error(`Invalid forceFallbackAdapter setting: "${r}"`);if(n=await navigator.gpu.requestAdapter({powerPreference:t,forceFallbackAdapter:r}),!n)throw Error(`Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.`)}}if(t===`webnn`&&(typeof navigator>`u`||!navigator.ml))throw Error(`WebNN is not supported in current environment`);{let r=(Lu(),_(Nu)).init;t===`webgpu`&&await r(`webgpu`,N(),e,n),t===`webnn`&&await r(`webnn`,N(),e)}},Vu=new Map,Hu=e=>{let t=N(),n=t.stackSave();try{let n=t.PTR_SIZE,r=t.stackAlloc(2*n);t._OrtGetInputOutputCount(e,r,r+n)!==0&&P(`Can't get session input/output count.`);let i=n===4?`i32`:`i64`;return[Number(t.getValue(r,i)),Number(t.getValue(r+n,i))]}finally{t.stackRestore(n)}},Uu=(e,t)=>{let n=N(),r=n.stackSave(),i=0;try{let r=n.PTR_SIZE,a=n.stackAlloc(2*r);n._OrtGetInputOutputMetadata(e,t,a,a+r)!==0&&P(`Can't get session input/output metadata.`);let o=Number(n.getValue(a,`*`));i=Number(n.getValue(a+r,`*`));let s=n.HEAP32[i/4];if(s===0)return[o,0];let c=n.HEAPU32[i/4+1],l=[];for(let e=0;e<c;e++){let t=Number(n.getValue(i+8+e*r,`*`));l.push(t===0?Number(n.getValue(i+8+(e+c)*r,`*`)):n.UTF8ToString(t))}return[o,s,l]}finally{n.stackRestore(r),i!==0&&n._OrtFree(i)}},Wu=e=>{let t=N(),n=t._malloc(e.byteLength);if(n===0)throw Error(`Can't create a session. failed to allocate a buffer of size ${e.byteLength}.`);return t.HEAPU8.set(e,n),[n,e.byteLength]},Gu=async(e,t)=>{let n,r,i=N();Array.isArray(e)?[n,r]=e:e.buffer===i.HEAPU8.buffer?[n,r]=[e.byteOffset,e.byteLength]:[n,r]=Wu(e);let a=0,o=0,s=0,c=[],l=[],u=[];try{if([o,c]=await Ot(t),t?.externalData&&i.mountExternalData){let e=[];for(let n of t.externalData){let t=typeof n==`string`?n:n.path;e.push(Rt(typeof n==`string`?n:n.data).then(e=>{i.mountExternalData(t,e)}))}await Promise.all(e)}for(let e of t?.executionProviders??[])if((typeof e==`string`?e:e.name)===`webnn`){if(i.shouldTransferToMLTensor=!1,typeof e!=`string`){let t=e,n=t?.context,r=t?.gpuDevice,a=t?.deviceType,o=t?.powerPreference;i.currentContext=n||(r?await i.webnnCreateMLContext(r):await i.webnnCreateMLContext({deviceType:a,powerPreference:o}))}else i.currentContext=await i.webnnCreateMLContext();break}a=await i._OrtCreateSession(n,r,o),i.webgpuOnCreateSession?.(a),a===0&&P(`Can't create a session.`),i.jsepOnCreateSession?.(),i.currentContext&&(i.webnnRegisterMLContext(a,i.currentContext),i.currentContext=void 0,i.shouldTransferToMLTensor=!0);let[e,d]=Hu(a),f=!!t?.enableGraphCapture,p=[],m=[],h=[],g=[],_=[];for(let t=0;t<e;t++){let[e,n,r]=Uu(a,t);e===0&&P(`Can't get an input name.`),l.push(e);let o=i.UTF8ToString(e);p.push(o),h.push(n===0?{name:o,isTensor:!1}:{name:o,isTensor:!0,type:jt(n),shape:r})}for(let n=0;n<d;n++){let[r,o,s]=Uu(a,n+e);r===0&&P(`Can't get an output name.`),u.push(r);let c=i.UTF8ToString(r);m.push(c),g.push(o===0?{name:c,isTensor:!1}:{name:c,isTensor:!0,type:jt(o),shape:s});{if(f&&t?.preferredOutputLocation===void 0){_.push(`gpu-buffer`);continue}let e=typeof t?.preferredOutputLocation==`string`?t.preferredOutputLocation:t?.preferredOutputLocation?.[c]??`cpu`,n=i.webnnIsGraphOutput;if(e===`cpu`&&n&&n(a,c)){_.push(`ml-tensor-cpu-output`);continue}if(e!==`cpu`&&e!==`cpu-pinned`&&e!==`gpu-buffer`&&e!==`ml-tensor`)throw Error(`Not supported preferred output location: ${e}.`);if(f&&e!==`gpu-buffer`)throw Error(`Not supported preferred output location: ${e}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);_.push(e)}}let v=null;return _.some(e=>e===`gpu-buffer`||e===`ml-tensor`||e===`ml-tensor-cpu-output`)&&(s=i._OrtCreateBinding(a),s===0&&P(`Can't create IO binding.`),v={handle:s,outputPreferredLocations:_,outputPreferredLocationsEncoded:_.map(e=>e===`ml-tensor-cpu-output`?`ml-tensor`:e).map(e=>Lt(e))}),Vu.set(a,[a,l,u,v,f,!1]),[a,p,m,h,g]}catch(e){throw l.forEach(e=>i._OrtFree(e)),u.forEach(e=>i._OrtFree(e)),s!==0&&i._OrtReleaseBinding(s)!==0&&P(`Can't release IO binding.`),a!==0&&i._OrtReleaseSession(a)!==0&&P(`Can't release session.`),e}finally{i._free(n),o!==0&&i._OrtReleaseSessionOptions(o)!==0&&P(`Can't release session options.`),c.forEach(e=>i._free(e)),i.unmountExternalData?.()}},Ku=e=>{let t=N(),n=Vu.get(e);if(!n)throw Error(`cannot release session. invalid session id: ${e}`);let[r,i,a,o,s]=n;o&&(s&&t._OrtClearBoundOutputs(o.handle)!==0&&P(`Can't clear bound outputs.`),t._OrtReleaseBinding(o.handle)!==0&&P(`Can't release IO binding.`)),t.jsepOnReleaseSession?.(e),t.webnnOnReleaseSession?.(e),t.webgpuOnReleaseSession?.(e),i.forEach(e=>t._OrtFree(e)),a.forEach(e=>t._OrtFree(e)),t._OrtReleaseSession(r)!==0&&P(`Can't release session.`),Vu.delete(e)},qu=async(e,t,n,r,i,a,o=!1)=>{if(!e){t.push(0);return}let s=N(),c=s.PTR_SIZE,l=e[0],u=e[1],d=e[3],f=d,p,m;if(l===`string`&&(d===`gpu-buffer`||d===`ml-tensor`))throw Error(`String tensor is not supported on GPU.`);if(o&&d!==`gpu-buffer`)throw Error(`External buffer must be provided for input/output index ${a} when enableGraphCapture is true.`);if(d===`gpu-buffer`){let t=e[2].gpuBuffer;m=Mt(At(l),u);{let e=s.jsepRegisterBuffer;if(!e)throw Error(`Tensor location "gpu-buffer" is not supported without using WebGPU.`);p=e(r,a,t,m)}}else if(d===`ml-tensor`){let t=e[2].mlTensor;m=Mt(At(l),u);let n=s.webnnRegisterMLTensor;if(!n)throw Error(`Tensor location "ml-tensor" is not supported without using WebNN.`);p=n(r,t,At(l),u)}else{let t=e[2];if(Array.isArray(t)){m=c*t.length,p=s._malloc(m),n.push(p);for(let e=0;e<t.length;e++){if(typeof t[e]!=`string`)throw TypeError(`tensor data at index ${e} is not a string`);s.setValue(p+e*c,vt(t[e],n),`*`)}}else{let e=s.webnnIsGraphInput,a=s.webnnIsGraphOutput;if(l!==`string`&&e&&a){let o=s.UTF8ToString(i);if(e(r,o)||a(r,o)){let e=At(l);m=Mt(e,u),f=`ml-tensor`;let n=s.webnnCreateTemporaryTensor,i=s.webnnUploadTensor;if(!n||!i)throw Error(`Tensor location "ml-tensor" is not supported without using WebNN.`);let a=await n(r,e,u);i(a,new Uint8Array(t.buffer,t.byteOffset,t.byteLength)),p=a}else m=t.byteLength,p=s._malloc(m),n.push(p),s.HEAPU8.set(new Uint8Array(t.buffer,t.byteOffset,m),p)}else m=t.byteLength,p=s._malloc(m),n.push(p),s.HEAPU8.set(new Uint8Array(t.buffer,t.byteOffset,m),p)}}let h=s.stackSave(),g=s.stackAlloc(4*u.length);try{u.forEach((e,t)=>s.setValue(g+t*c,e,c===4?`i32`:`i64`));let e=s._OrtCreateTensor(At(l),p,m,g,u.length,Lt(f));e===0&&P(`Can't create tensor for input/output. session=${r}, index=${a}.`),t.push(e)}finally{s.stackRestore(h)}},Ju=async(e,t,n,r,i,a)=>{let o=N(),s=o.PTR_SIZE,c=Vu.get(e);if(!c)throw Error(`cannot run inference. invalid session id: ${e}`);let l=c[0],u=c[1],d=c[2],f=c[3],p=c[4],m=c[5],h=t.length,g=r.length,_=0,v=[],y=[],b=[],x=[],S=[],C=o.stackSave(),w=o.stackAlloc(h*s),ee=o.stackAlloc(h*s),T=o.stackAlloc(g*s),E=o.stackAlloc(g*s);try{[_,v]=xt(a),Ee(`wasm prepareInputOutputTensor`);for(let r=0;r<h;r++)await qu(n[r],y,x,e,u[t[r]],t[r],p);for(let t=0;t<g;t++)await qu(i[t],b,x,e,d[r[t]],h+r[t],p);De(`wasm prepareInputOutputTensor`);for(let e=0;e<h;e++)o.setValue(w+e*s,y[e],`*`),o.setValue(ee+e*s,u[t[e]],`*`);for(let e=0;e<g;e++)o.setValue(T+e*s,b[e],`*`),o.setValue(E+e*s,d[r[e]],`*`);if(f&&!m){let{handle:n,outputPreferredLocations:a,outputPreferredLocationsEncoded:s}=f;if(u.length!==h)throw Error(`input count from feeds (${h}) is expected to be always equal to model's input count (${u.length}).`);Ee(`wasm bindInputsOutputs`);for(let r=0;r<h;r++){let i=t[r];await o._OrtBindInput(n,u[i],y[r])!==0&&P(`Can't bind input[${r}] for session=${e}.`)}for(let t=0;t<g;t++){let c=r[t];i[t]?.[3]?(S.push(b[t]),o._OrtBindOutput(n,d[c],b[t],0)!==0&&P(`Can't bind pre-allocated output[${t}] for session=${e}.`)):o._OrtBindOutput(n,d[c],0,s[c])!==0&&P(`Can't bind output[${t}] to ${a[t]} for session=${e}.`)}De(`wasm bindInputsOutputs`),Vu.set(e,[l,u,d,f,p,!0])}o.jsepOnRunStart?.(l),o.webnnOnRunStart?.(l);let c;c=f?await o._OrtRunWithBinding(l,f.handle,g,T,_):await o._OrtRun(l,ee,w,h,E,g,T,_),c!==0&&P(`failed to call OrtRun().`);let C=[],D=[];Ee(`wasm ProcessOutputTensor`);for(let t=0;t<g;t++){let n=Number(o.getValue(T+t*s,`*`));if(n===b[t]||S.includes(b[t])){C.push(i[t]),n!==b[t]&&o._OrtReleaseTensor(n)!==0&&P(`Can't release tensor.`);continue}let a=o.stackSave(),c=o.stackAlloc(4*s),l=!1,u,d=0;try{o._OrtGetTensorData(n,c,c+s,c+2*s,c+3*s)!==0&&P(`Can't access output tensor data on index ${t}.`);let i=s===4?`i32`:`i64`,a=Number(o.getValue(c,i));d=o.getValue(c+s,`*`);let p=o.getValue(c+s*2,`*`),m=Number(o.getValue(c+s*3,i)),h=[];for(let e=0;e<m;e++)h.push(Number(o.getValue(p+e*s,i)));o._OrtFree(p)!==0&&P(`Can't free memory for tensor dims.`);let g=h.reduce((e,t)=>e*t,1);u=jt(a);let _=f?.outputPreferredLocations[r[t]];if(u===`string`){if(_===`gpu-buffer`||_===`ml-tensor`)throw Error(`String tensor is not supported on GPU.`);let e=[];for(let t=0;t<g;t++){let n=o.getValue(d+t*s,`*`),r=o.getValue(d+(t+1)*s,`*`),i=t===g-1?void 0:r-n;e.push(o.UTF8ToString(n,i))}C.push([u,h,e,`cpu`])}else if(_===`gpu-buffer`&&g>0){let e=o.jsepGetBuffer;if(!e)throw Error(`preferredLocation "gpu-buffer" is not supported without using WebGPU.`);let t=e(d),r=Mt(a,g);if(r===void 0||!Ft(u))throw Error(`Unsupported data type: ${u}`);l=!0,C.push([u,h,{gpuBuffer:t,download:o.jsepCreateDownloader(t,r,u),dispose:()=>{o._OrtReleaseTensor(n)!==0&&P(`Can't release tensor.`)}},`gpu-buffer`])}else if(_===`ml-tensor`&&g>0){let t=o.webnnEnsureTensor,r=o.webnnIsGraphInputOutputTypeSupported;if(!t||!r)throw Error(`preferredLocation "ml-tensor" is not supported without using WebNN.`);if(Mt(a,g)===void 0||!It(u))throw Error(`Unsupported data type: ${u}`);if(!r(e,u,!1))throw Error(`preferredLocation "ml-tensor" for ${u} output is not supported by current WebNN Context.`);let i=await t(e,d,a,h,!1);l=!0,C.push([u,h,{mlTensor:i,download:o.webnnCreateMLTensorDownloader(d,u),dispose:()=>{o.webnnReleaseTensorId(d),o._OrtReleaseTensor(n)}},`ml-tensor`])}else if(_===`ml-tensor-cpu-output`&&g>0){let e=o.webnnCreateMLTensorDownloader(d,u)(),t=C.length;l=!0,D.push((async()=>{let r=[t,await e];return o.webnnReleaseTensorId(d),o._OrtReleaseTensor(n),r})()),C.push([u,h,[],`cpu`])}else{let e=new(Nt(u))(g);new Uint8Array(e.buffer,e.byteOffset,e.byteLength).set(o.HEAPU8.subarray(d,d+e.byteLength)),C.push([u,h,e,`cpu`])}}finally{o.stackRestore(a),u===`string`&&d&&o._free(d),l||o._OrtReleaseTensor(n)}}f&&!p&&(o._OrtClearBoundOutputs(f.handle)!==0&&P(`Can't clear bound outputs.`),Vu.set(e,[l,u,d,f,p,!1]));for(let[e,t]of await Promise.all(D))C[e][2]=t;return De(`wasm ProcessOutputTensor`),C}finally{o.webnnOnRunEnd?.(l),o.stackRestore(C),y.forEach(e=>o._OrtReleaseTensor(e)),b.forEach(e=>o._OrtReleaseTensor(e)),x.forEach(e=>o._free(e)),_!==0&&o._OrtReleaseRunOptions(_),v.forEach(e=>o._free(e))}},Yu=e=>{let t=N(),n=Vu.get(e);if(!n)throw Error(`invalid session id`);let r=n[0],i=t._OrtEndProfiling(r);i===0&&P(`Can't get an profile file name.`),t._OrtFree(i)},Xu=e=>{let t=[];for(let n of e){let e=n[2];!Array.isArray(e)&&`buffer`in e&&t.push(e.buffer)}return t}}),Qu,$u,ed,td,nd,rd,id,ad,od,sd,cd,ld,ud,dd,fd,pd,md,hd,gd=m(()=>{Le(),Zu(),_t(),ct(),Qu=()=>!!k.wasm.proxy&&typeof document<`u`,ed=!1,td=!1,nd=!1,ad=new Map,od=(e,t)=>{let n=ad.get(e);n?n.push(t):ad.set(e,[t])},sd=()=>{if(ed||!td||nd||!$u)throw Error(`worker not ready`)},cd=e=>{switch(e.data.type){case`init-wasm`:ed=!1,e.data.err?(nd=!0,id[1](e.data.err)):(td=!0,id[0]()),rd&&=(URL.revokeObjectURL(rd),void 0);break;case`init-ep`:case`copy-from`:case`create`:case`release`:case`run`:case`end-profiling`:{let t=ad.get(e.data.type);e.data.err?t.shift()[1](e.data.err):t.shift()[0](e.data.out);break}}},ld=async()=>{if(!td){if(ed)throw Error(`multiple calls to 'initWasm()' detected.`);if(nd)throw Error(`previous call to 'initWasm()' failed.`);if(ed=!0,Qu())return new Promise((e,t)=>{$u?.terminate(),at().then(([n,r])=>{try{$u=r,$u.onerror=e=>t(e),$u.onmessage=cd,id=[e,t];let i={type:`init-wasm`,in:k};!i.in.wasm.wasmPaths&&(n||Xe)&&(i.in.wasm.wasmPaths={wasm:new URL(``+new URL(`ort-wasm-simd-threaded.jsep-DC5y_g6C.wasm`,import.meta.url).href,``+import.meta.url).href}),$u.postMessage(i),rd=n}catch(e){t(e)}},t)});try{await gt(k.wasm),await zu(k),td=!0}catch(e){throw nd=!0,e}finally{ed=!1}}},ud=async e=>{if(Qu())return sd(),new Promise((t,n)=>{od(`init-ep`,[t,n]);let r={type:`init-ep`,in:{epName:e,env:k}};$u.postMessage(r)});await Bu(k,e)},dd=async e=>Qu()?(sd(),new Promise((t,n)=>{od(`copy-from`,[t,n]);let r={type:`copy-from`,in:{buffer:e}};$u.postMessage(r,[e.buffer])})):Wu(e),fd=async(e,t)=>{if(Qu()){if(t?.preferredOutputLocation)throw Error(`session option "preferredOutputLocation" is not supported for proxy.`);return sd(),new Promise((n,r)=>{od(`create`,[n,r]);let i={type:`create`,in:{model:e,options:{...t}}},a=[];e instanceof Uint8Array&&a.push(e.buffer),$u.postMessage(i,a)})}return Gu(e,t)},pd=async e=>{if(Qu())return sd(),new Promise((t,n)=>{od(`release`,[t,n]);let r={type:`release`,in:e};$u.postMessage(r)});Ku(e)},md=async(e,t,n,r,i,a)=>{if(Qu()){if(n.some(e=>e[3]!==`cpu`))throw Error(`input tensor on GPU is not supported for proxy.`);if(i.some(e=>e))throw Error(`pre-allocated output tensor is not supported for proxy.`);return sd(),new Promise((i,o)=>{od(`run`,[i,o]);let s=n,c={type:`run`,in:{sessionId:e,inputIndices:t,inputs:s,outputIndices:r,options:a}};$u.postMessage(c,Xu(s))})}return Ju(e,t,n,r,i,a)},hd=async e=>{if(Qu())return sd(),new Promise((t,n)=>{od(`end-profiling`,[t,n]);let r={type:`end-profiling`,in:e};$u.postMessage(r)});Yu(e)}}),_d,vd,yd,bd=m(()=>{Le(),gd(),F(),Re(),zt(),_d=(e,t)=>{switch(e.location){case`cpu`:return[e.type,e.dims,e.data,`cpu`];case`gpu-buffer`:return[e.type,e.dims,{gpuBuffer:e.gpuBuffer},`gpu-buffer`];case`ml-tensor`:return[e.type,e.dims,{mlTensor:e.mlTensor},`ml-tensor`];default:throw Error(`invalid data location: ${e.location} for ${t()}`)}},vd=e=>{switch(e[3]){case`cpu`:return new be(e[0],e[2],e[1]);case`gpu-buffer`:{let t=e[0];if(!Ft(t))throw Error(`not supported data type: ${t} for deserializing GPU tensor`);let{gpuBuffer:n,download:r,dispose:i}=e[2];return be.fromGpuBuffer(n,{dataType:t,dims:e[1],download:r,dispose:i})}case`ml-tensor`:{let t=e[0];if(!It(t))throw Error(`not supported data type: ${t} for deserializing MLTensor tensor`);let{mlTensor:n,download:r,dispose:i}=e[2];return be.fromMLTensor(n,{dataType:t,dims:e[1],download:r,dispose:i})}default:throw Error(`invalid data location: ${e[3]}`)}},yd=class{async fetchModelAndCopyToWasmMemory(e){return dd(await Rt(e))}async loadModel(e,t){we();let n;n=typeof e==`string`?await this.fetchModelAndCopyToWasmMemory(e):e,[this.sessionId,this.inputNames,this.outputNames,this.inputMetadata,this.outputMetadata]=await fd(n,t),Te()}async dispose(){return pd(this.sessionId)}async run(e,t,n){we();let r=[],i=[];Object.entries(e).forEach(e=>{let t=e[0],n=e[1],a=this.inputNames.indexOf(t);if(a===-1)throw Error(`invalid input '${t}'`);r.push(n),i.push(a)});let a=[],o=[];Object.entries(t).forEach(e=>{let t=e[0],n=e[1],r=this.outputNames.indexOf(t);if(r===-1)throw Error(`invalid output '${t}'`);a.push(n),o.push(r)});let s=r.map((e,t)=>_d(e,()=>`input "${this.inputNames[i[t]]}"`)),c=a.map((e,t)=>e?_d(e,()=>`output "${this.outputNames[o[t]]}"`):null),l=await md(this.sessionId,i,s,o,c,n),u={};for(let e=0;e<l.length;e++)u[this.outputNames[o[e]]]=a[e]??vd(l[e]);return Te(),u}startProfiling(){}endProfiling(){hd(this.sessionId)}}}),xd={};h(xd,{OnnxruntimeWebAssemblyBackend:()=>Cd,initializeFlags:()=>Sd,wasmBackend:()=>wd});var Sd,Cd,wd,Td=m(()=>{Le(),gd(),bd(),Sd=()=>{(typeof k.wasm.initTimeout!=`number`||k.wasm.initTimeout<0)&&(k.wasm.initTimeout=0);let e=k.wasm.simd;if(typeof e!=`boolean`&&e!==void 0&&e!==`fixed`&&e!==`relaxed`&&(console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`),k.wasm.simd=!1),typeof k.wasm.proxy!=`boolean`&&(k.wasm.proxy=!1),typeof k.wasm.trace!=`boolean`&&(k.wasm.trace=!1),typeof k.wasm.numThreads!=`number`||!Number.isInteger(k.wasm.numThreads)||k.wasm.numThreads<=0)if(typeof self<`u`&&!self.crossOriginIsolated)k.wasm.numThreads=1;else{let e=typeof navigator>`u`?p(`node:os`).cpus().length:navigator.hardwareConcurrency;k.wasm.numThreads=Math.min(4,Math.ceil((e||1)/2))}},Cd=class{async init(e){Sd(),await ld(),await ud(e)}async createInferenceSessionHandler(e,t){let n=new yd;return await n.loadModel(e,t),n}},wd=new Cd});Le(),Le(),Le();var Ed=`1.27.0`;{let e=(Td(),_(xd)).wasmBackend;b(`webgpu`,e,5),b(`webnn`,e,5),b(`cpu`,e,10),b(`wasm`,e,10)}Object.defineProperty(k.versions,"web",{value:Ed,enumerable:!0});async function Dd(e,t={}){let n=t.width??224,r=t.height??224,i=t.normalization??`imagenet`,a=t.resizeMode??`cover`,o=await Od(e),s=document.createElement(`canvas`),c=s.getContext(`2d`,{willReadFrequently:!0});if(!c)throw Error(`Canvas is unavailable`);s.width=n,s.height=r;let l=o.naturalWidth||o.width,u=o.naturalHeight||o.height;if(a===`contain`){let e=Math.min(n/l,r/u),t=l*e,i=u*e;c.fillStyle=`rgb(114, 114, 114)`,c.fillRect(0,0,n,r),c.drawImage(o,(n-t)/2,(r-i)/2,t,i)}else{let e=Math.min(l,u),t=(l-e)/2,i=(u-e)/2;c.drawImage(o,t,i,e,e,0,0,n,r)}let d=c.getImageData(0,0,n,r),f=new Float32Array(3*n*r),p=[.485,.456,.406],m=[.229,.224,.225];for(let e=0;e<n*r;e+=1){let t=e*4,a=d.data[t]/255,o=d.data[t+1]/255,s=d.data[t+2]/255;i===`zero-one`?(f[e]=a,f[n*r+e]=o,f[2*n*r+e]=s):(f[e]=(a-p[0])/m[0],f[n*r+e]=(o-p[1])/m[1],f[2*n*r+e]=(s-p[2])/m[2])}return new be(`float32`,f,[1,3,r,n])}async function Od(e){if(e instanceof HTMLImageElement)return await e.decode().catch(()=>void 0),e;if(e instanceof HTMLCanvasElement){let t=new Image;return t.src=e.toDataURL(`image/png`),await t.decode(),t}let t=typeof e==`string`?e:URL.createObjectURL(e),n=typeof e!=`string`,r=new Image;r.decoding=`async`,r.src=t;try{return await r.decode(),r}finally{n&&URL.revokeObjectURL(t)}}var kd=Promise.resolve();function Ad(e){let t=kd.then(e,e);return kd=t.then(()=>void 0,()=>void 0),t}var jd={aerosol_can:`hazardous`,aluminium_drink_can:`bottle_can`,battery:`hazardous`,cardboard_box:`paper_cardboard`,chemical_container:`hazardous`,dirty_plastic_bag:`landfill`,disposable_cutlery:`landfill`,disposable_diaper:`landfill`,drink_carton:`paper_cardboard`,electronic_cable:`hazardous`,food_waste:`organic`,fruit_peel:`organic`,glass_drink_bottle:`bottle_can`,hair_clip:`landfill`,hair_tie:`landfill`,light_bulb:`hazardous`,medical_mask:`landfill`,medicine_blister_pack:`landfill`,mobile_phone:`hazardous`,newspaper:`paper_cardboard`,paper_bag:`paper_cardboard`,paper_cup:`landfill`,paper_plate:`landfill`,paperboard_packaging:`paper_cardboard`,pen_marker:`landfill`,phone_case:`landfill`,plastic_bag:`clean_plastic`,plastic_cosmetic_container:`clean_plastic`,plastic_cup_lid:`clean_plastic`,plastic_food_container:`clean_plastic`,plastic_takeaway_cup:`clean_plastic`,plastic_water_bottle:`bottle_can`,power_bank:`hazardous`,printing_paper:`paper_cardboard`,sanitary_pad:`landfill`,snack_wrapper:`clean_plastic`,steel_food_can:`bottle_can`,styrofoam_container:`clean_plastic`,tissue:`landfill`,unknown:`unknown`,vegetable_scraps:`organic`};function Md(e){return jd[e]}function Nd(e){if(e!==`unknown`)return e===`hazardous`?`special_handling`:e}var Pd=a([i(e()),n({labels:i(n({index:o().int().nonnegative(),code:e(),nameEn:e().optional(),nameVi:e().optional()}))})]);n({itemCode:e()});var Fd=1e-12;function Id(e){let t=Math.max(...e),n=e.map(e=>Math.exp(e-t)),r=n.reduce((e,t)=>e+t,0);return n.map(e=>e/r)}function Ld(e,t){if(!Number.isFinite(t)||t<=0)throw Error(`Ensemble temperature must be positive`);return Id(e.map(e=>Math.log(Math.max(e,Fd))/t)).map(e=>Math.log(Math.max(e,Fd)))}function Rd(e,t,n){let r=n.length,i=t.modelPaths.length;if(e.length!==i||t.temperatures.length!==i||t.theta.length!==i||t.bias.length!==r||t.theta.some(e=>e.length!==r)||e.some(e=>e.length!==r))throw Error(`Ensemble configuration does not match its model outputs and labels`);let a=e.map((e,n)=>Ld(e,t.temperatures[n]));return Id(n.map((e,n)=>{let r=Id(t.theta.map(e=>e[n]));return t.bias[n]+r.reduce((e,t,r)=>e+t*a[r][n],0)})).map((e,t)=>({score:e,code:n[t]}))}function zd(e){if(!e||typeof e!=`object`)throw Error(`Ensemble configuration is malformed`);let t=e;if(typeof t.version!=`string`||!Array.isArray(t.modelPaths)||!t.modelPaths.every(e=>typeof e==`string`)||!Array.isArray(t.temperatures)||!t.temperatures.every(Number.isFinite)||!Array.isArray(t.theta)||!t.theta.every(e=>Array.isArray(e)&&e.every(Number.isFinite))||!Array.isArray(t.bias)||!t.bias.every(Number.isFinite))throw Error(`Ensemble configuration is malformed`);return t}function Bd(e,t,n=.53){let r=Vd(e),i=Vd(t),a=new Map;for(let e of r){let t=Md(e.code);t&&a.set(t,(a.get(t)??0)+e.score)}let o=Math.min(1,Math.max(0,n)),s=i.map(({code:e,score:t})=>{let n=e;return{code:n,score:o*t+(1-o)*(a.get(n)??0)}}).sort((e,t)=>t.score-e.score),c=s[0];if(!c||c.code===`unknown`)return;let l=r.filter(e=>Md(e.code)===c.code&&e.code!==`unknown`).sort((e,t)=>t.score-e.score),u=l[0];if(u)return{itemCode:u.code,itemScore:u.score,itemMargin:u.score-(l[1]?.score??0),binCode:c.code,binScore:c.score,binMargin:c.score-(s[1]?.score??0)}}function Vd(e){if(!e.length)return[];let t=e.map(({score:e})=>Number.isFinite(e)?e:0),n=t.reduce((e,t)=>e+t,0);if(t.every(e=>e>=0&&e<=1)&&n>.98&&n<1.02)return e.map((e,n)=>({...e,score:t[n]??0}));let r=Math.max(...t),i=t.map(e=>Math.exp(e-r)),a=i.reduce((e,t)=>e+t,0);return e.map((e,t)=>({...e,score:(i[t]??0)/a}))}(typeof crossOriginIsolated>`u`||!crossOriginIsolated)&&(k.wasm.numThreads=1,k.wasm.proxy=!1);var Hd=new Set([`plastic`,`metal`,`paper_cardboard`,`organic`,`glass`,`electronic_battery`,`mixed_uncertain`]),Ud=class{itemAssetsPromise;labelsPromise;binAssetsPromise;materialAssetsPromise;componentProviderPromise;warmupPromise;async identify(e){return Gd(this.runInference(e),6e4)}async prepare(){this.warmupPromise||=Promise.all([this.loadItemAssets(),this.loadLabels(),this.loadBinAssets()]).then(async([e,,t])=>{let n=new be(`float32`,new Float32Array(150528),[1,3,224,224]),r=[...e.sessions,t?.session].filter(e=>!!e);for(let e of r){let t=e.inputNames[0];t&&await Ad(()=>e.run({[t]:n}))}}),await this.warmupPromise}async identifyComponents(e,t){try{return await Gd((await this.loadComponentProvider()).detect(e,t),2500)}catch(e){console.warn(`Component detection was skipped; sorting rules will provide the component guide.`,e);return}}async runInference(e){let[t,n,r]=await Promise.all([this.loadItemAssets(),this.loadLabels(),this.loadBinAssets()]),i=await Dd(e,{width:224,height:224,normalization:`zero-one`}),a=[];for(let e of t.sessions)a.push(await this.runRawClassifier(e,n.length,i));let o=t.config?Rd(a,t.config,n.map(({code:e})=>e)):a[0].map((e,t)=>({score:e,code:n[t].code})),s=r?await this.runRawClassifier(r.session,r.labels.length,i).then(e=>e.map((e,t)=>({score:e,code:r.labels[t].code}))).catch(e=>{console.warn(`Bin classifier failed; falling back to item-only inference.`,e)}):void 0;try{return s?this.resolveEnsembledResult(o,s):this.resolveItemOnlyResult(o)}catch(e){if(!(e instanceof c)||![`ITEM_NOT_RECOGNISED`,`ITEM_AMBIGUOUS`].includes(e.code))throw e;return this.resolveMaterialFallback(i,e)}}async resolveMaterialFallback(e,t){try{let n=await this.loadMaterialAssets(),r=Wd(await this.runRawClassifier(n.session,n.labels.length,e)).map((e,t)=>({score:e,code:n.labels[t].code})).sort((e,t)=>t.score-e.score),i=r[0],a=r[1],o=i?.code===`electronic_battery`?.7:.95;if(!i||i.score<o||i.score-(a?.score??0)<.05)throw new c(`MATERIAL_NOT_RECOGNISED`,`Broad-material result did not clear its calibrated acceptance thresholds.`,t);return{kind:`material`,materialCode:i.code,confidence:i.score}}catch(e){throw e instanceof c&&e.code===`MATERIAL_NOT_RECOGNISED`?e:(console.warn(`Material fallback failed; requesting user feedback instead.`,e),new c(`MATERIAL_NOT_RECOGNISED`,`Broad-material inference could not provide a reliable result.`,{exactItemError:t,materialError:e}))}}resolveEnsembledResult(e,t){let n=Bd(e,t,.53);if(!n)throw new c(`ITEM_NOT_RECOGNISED`,`Unknown class`);if(n.binScore<.45||n.binMargin<.05||n.itemScore<.18||n.itemMargin<.02)throw new c(`ITEM_AMBIGUOUS`,`Model result is uncertain`);if(this.getSupportedItem(n.itemCode).specialHandling&&n.itemScore<.8)throw new c(`ITEM_AMBIGUOUS`,`Special-handling item result is uncertain`);return{kind:`item`,itemCode:n.itemCode,binCode:Nd(n.binCode)}}resolveItemOnlyResult(e){let t=[...e].sort((e,t)=>t.score-e.score),n=t[0],r=t[1];if(!n||n.code===`unknown`)throw new c(`ITEM_NOT_RECOGNISED`,`Unknown class`);if(n.score<.55||r&&n.score-r.score<.15)throw new c(`ITEM_AMBIGUOUS`,`Model result is uncertain`);if(this.getSupportedItem(n.code).specialHandling&&n.score<.8)throw new c(`ITEM_AMBIGUOUS`,`Special-handling item result is uncertain`);return{kind:`item`,itemCode:n.code}}getSupportedItem(e){let t=s.find(t=>t.code===e&&t.isActive&&t.code!==`unknown`);if(!t)throw new c(`ITEM_NOT_RECOGNISED`,`Unsupported class`);return t}async runRawClassifier(e,t,n){let r=e.inputNames[0],i=e.outputNames[0];if(!r||!i)throw new c(`MODEL_LOAD_FAILED`,`Model input or output names are missing`);let a;try{a=await Ad(()=>e.run({[r]:n}))}catch(e){throw new c(`INFERENCE_FAILED`,`ONNX inference failed`,e)}let o=a[i],s=Array.from(o?.data??[]).map(Number);if(!s.length||s.some(e=>Number.isNaN(e)))throw new c(`INFERENCE_FAILED`,`Model output is malformed`);if(s.length!==t)throw new c(`MODEL_LOAD_FAILED`,`Model returns ${s.length} classes but its labels file contains ${t}`);return s}loadComponentProvider(){return this.componentProviderPromise||=t(async()=>{let{OnnxComponentProvider:e}=await import(`./onnxComponentProvider-B2JXSGcy.js`);return{OnnxComponentProvider:e}},[],import.meta.url).then(({OnnxComponentProvider:e})=>new e),this.componentProviderPromise}loadItemAssets(){return this.itemAssetsPromise||=fetch(`./models/waste_classifier_ensemble.json`).then(e=>{if(!e.ok)throw Error(`Ensemble configuration is not available`);return e.json()}).then(zd).then(async e=>{let t=[];for(let n of e.modelPaths){let e=/^(?:https?:)?\//.test(n)?n:`./models/${n}`;t.push(await je.create(e,{executionProviders:[`wasm`]}))}return{sessions:t,config:e}}).catch(e=>{throw e instanceof c?e:new c(`MODEL_LOAD_FAILED`,`Calibrated ensemble failed to load`,e)}),this.itemAssetsPromise}loadLabels(){return this.labelsPromise||=fetch(`./models/labels.json`).then(e=>{if(!e.ok)throw new c(`MODEL_NOT_CONFIGURED`,`AI labels are not configured.`);return e.json()}).then(e=>{let t=Pd.parse(e);return Array.isArray(t)?t.map((e,t)=>({index:t,code:e})):t.labels.map(({index:e,code:t})=>({index:e,code:t}))}).catch(e=>{throw e instanceof c?e:new c(`MODEL_LOAD_FAILED`,`Labels failed to load`,e)}),this.labelsPromise}loadBinAssets(){return Promise.resolve(void 0)}loadMaterialAssets(){return this.materialAssetsPromise||=Promise.all([je.create(`./models/waste_material_classifier.onnx`,{executionProviders:[`wasm`]}),fetch(`./models/material_labels.json`).then(e=>{if(!e.ok)throw Error(`Material labels are not configured`);return e.json()}).then(e=>{let t=Pd.parse(e),n=Array.isArray(t)?t.map((e,t)=>({index:t,code:e})):t.labels.map(({index:e,code:t})=>({index:e,code:t}));if(n.some(({code:e})=>!Hd.has(e)))throw Error(`Material labels contain an unsupported code`);return n})]).then(([e,t])=>({session:e,labels:t})).catch(e=>{throw new c(`MODEL_LOAD_FAILED`,`Material fallback model failed to load`,e)}),this.materialAssetsPromise}};function Wd(e){let t=e.reduce((e,t)=>e+t,0);if(e.every(e=>e>=0&&e<=1)&&t>.98&&t<1.02)return e;let n=Math.max(...e),r=e.map(e=>Math.exp(e-n)),i=r.reduce((e,t)=>e+t,0);return r.map(e=>e/i)}async function Gd(e,t){let n,r=new Promise((e,r)=>{n=window.setTimeout(()=>r(new c(`INFERENCE_TIMEOUT`,`Inference timed out`)),t)});try{return await Promise.race([e,r])}finally{n&&window.clearTimeout(n)}}export{Ud as OnnxVisionProvider,Dd as n,je as r,Ad as t};