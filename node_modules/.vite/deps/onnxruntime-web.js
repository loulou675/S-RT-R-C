...
//#region node_modules/.pnpm/onnxruntime-web@1.27.0/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs
/*!
...
`));
	...
	async function be() {
		...
		}) : o ? a(new WebAssembly.Instance(y, G()), y) : (ae ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("../../.pnpm/onnxruntime-web@1.27.0/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href, l = await (async function(f) {
			var w = ae;
			if (!g && !z(w)) try {
			...
			if (dr = !0, Rt()) return new Promise((t, e) => {
				Fe?.terminate(), _s().then(([r, n]) => {
					try {
						...
						!o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = { wasm: new URL("../../.pnpm/onnxruntime-web@1.27.0/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Fe.postMessage(o), fn = r;
					} catch (o) {
						e(o);
					}
				}, e);
