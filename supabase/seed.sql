...
values
  ('rmit_vietnam', 'RMIT Việt Nam', 'RMIT Vietnam', 'Vietnam', 'Ho Chi Minh City', 'Hướng dẫn phân loại rác cho trạm thùng rác RMIT Việt Nam.', 'Waste sorting guidance for the selected RMIT Vietnam waste station.', true)
...
with site as (
  select id from public.site_profiles where code = 'rmit_vietnam'
)
...
from (
  values
    ('plastic_water_bottle', 'Chai nước nhựa', 'Plastic water bottle', 'pet_plastic', 'bottle', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_soft_drink_bottle', 'Chai nước ngọt nhựa', 'Plastic soft-drink bottle', 'pet_plastic', 'bottle', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('aluminium_drink_can', 'Lon nước nhôm', 'Aluminium drink can', 'aluminium', 'can', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('steel_food_can', 'Lon thực phẩm thép', 'Steel food can', 'steel', 'can', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('glass_drink_bottle', 'Chai thủy tinh', 'Glass drink bottle', 'glass', 'bottle', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_takeaway_cup', 'Ly nhựa mang đi', 'Plastic takeaway cup', 'rigid_plastic', 'cup', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_cup_lid', 'Nắp ly nhựa', 'Plastic cup lid', 'rigid_plastic', 'lid', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_straw', 'Ống hút nhựa', 'Plastic straw', 'mixed_plastic', 'straw', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_food_container', 'Hộp nhựa đựng thức ăn', 'Plastic food container', 'rigid_plastic', 'container', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_takeaway_box', 'Hộp nhựa mang đi', 'Plastic takeaway box', 'rigid_plastic', 'container', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('clean_plastic_bag', 'Túi nhựa sạch', 'Clean plastic bag', 'soft_plastic', 'bag', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('dirty_plastic_bag', 'Túi nhựa bẩn', 'Dirty plastic bag', 'soft_plastic', 'bag', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('snack_wrapper', 'Vỏ gói snack', 'Snack wrapper', 'mixed_plastic', 'wrapper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('instant_noodle_packaging', 'Bao bì mì ăn liền', 'Instant noodle packaging', 'mixed_plastic', 'wrapper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('clean_styrofoam_container', 'Hộp xốp sạch', 'Clean styrofoam container', 'mixed_plastic', 'foam', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('dirty_styrofoam_container', 'Hộp xốp bẩn', 'Dirty styrofoam container', 'mixed_plastic', 'foam', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('printing_paper', 'Giấy in', 'Printing paper', 'paper', 'paper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('notebook_paper', 'Giấy vở', 'Notebook paper', 'paper', 'paper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('newspaper', 'Báo giấy', 'Newspaper', 'paper', 'paper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('magazine', 'Tạp chí', 'Magazine', 'paper', 'paper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('paper_bag', 'Túi giấy', 'Paper bag', 'paper', 'bag', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('cardboard_box', 'Thùng carton', 'Cardboard box', 'cardboard', 'box', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('pizza_box', 'Hộp pizza', 'Pizza box', 'cardboard', 'box', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('paper_cup', 'Ly giấy', 'Paper cup', 'mixed_material', 'cup', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('tissue', 'Khăn giấy', 'Tissue', 'paper', 'paper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('paper_napkin', 'Khăn ăn giấy', 'Paper napkin', 'paper', 'paper', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('food_waste', 'Thức ăn thừa', 'Food waste', 'organic', 'food', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('leftover_rice', 'Cơm thừa', 'Leftover rice', 'organic', 'food', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('leftover_noodles', 'Mì thừa', 'Leftover noodles', 'organic', 'food', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('fruit_peel', 'Vỏ trái cây', 'Fruit peel', 'organic', 'food', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('coffee_grounds', 'Bã cà phê', 'Coffee grounds', 'organic', 'food', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('tea_bag', 'Túi trà', 'Tea bag', 'mixed_material', 'food', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('leftover_drink', 'Đồ uống thừa', 'Leftover drink', 'organic', 'liquid', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('milk_tea_cup', 'Ly trà sữa', 'Milk tea cup', 'rigid_plastic', 'cup', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_spoon', 'Muỗng nhựa', 'Plastic spoon', 'mixed_plastic', 'utensil', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('plastic_fork', 'Nĩa nhựa', 'Plastic fork', 'mixed_plastic', 'utensil', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('wooden_utensil', 'Dụng cụ gỗ dùng một lần', 'Wooden utensil', 'wood', 'utensil', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('battery', 'Pin', 'Battery', 'hazardous', 'battery', true, true, 'BASED_ON_RMIT_SIGNAGE'),
    ('mobile_phone', 'Điện thoại di động', 'Mobile phone', 'electronic', 'device', true, true, 'BASED_ON_RMIT_SIGNAGE'),
    ('electronic_cable', 'Dây cáp điện tử', 'Electronic cable', 'electronic', 'cable', true, true, 'BASED_ON_RMIT_SIGNAGE'),
    ('broken_glass', 'Thủy tinh vỡ', 'Broken glass', 'glass', 'glass', true, true, 'BASED_ON_RMIT_SIGNAGE'),
    ('light_bulb', 'Bóng đèn', 'Light bulb', 'hazardous', 'bulb', true, true, 'BASED_ON_RMIT_SIGNAGE'),
    ('chemical_container', 'Bao bì hóa chất', 'Chemical container', 'hazardous', 'container', true, true, 'BASED_ON_RMIT_SIGNAGE'),
    ('medical_mask', 'Khẩu trang y tế', 'Medical mask', 'mixed_material', 'mask', false, false, 'BASED_ON_RMIT_SIGNAGE'),
    ('unknown', 'Vật phẩm chưa xác định', 'Unknown item', 'unknown', 'unknown', false, false, 'PENDING_RMIT_CONFIRMATION')
...
with site as (select id from public.site_profiles where code = 'rmit_vietnam'),
...
rules as (
  ...
  from (
    values
      ...
      ('battery', 'default', 'special_handling', 'Vật phẩm này cần xử lý riêng.', 'Special handling is required for this item.', '["Không bỏ vào năm thùng rác thông thường.","Dùng điểm thu gom được phê duyệt hoặc hỏi nhân viên RMIT."]'::jsonb, '["Do not place it in the five general waste bins.","Use an approved collection point or follow instructions from RMIT staff."]'::jsonb, 'Không cố tháo, đập vỡ hoặc xử lý sâu vật phẩm này.', 'Do not dismantle, crush or attempt detailed handling of this item.', '[]'::jsonb),
      ('broken_glass', 'default', 'special_handling', 'Vật phẩm này cần xử lý riêng.', 'Special handling is required for this item.', '["Không bỏ vào năm thùng rác thông thường.","Dùng điểm thu gom được phê duyệt hoặc hỏi nhân viên RMIT."]'::jsonb, '["Do not place it in the five general waste bins.","Use an approved collection point or follow instructions from RMIT staff."]'::jsonb, 'Không cố tháo, đập vỡ hoặc xử lý sâu vật phẩm này.', 'Do not dismantle, crush or attempt detailed handling of this item.', '[]'::jsonb)
...
select
  ...
  rules.warning_vi, rules.warning_en, rules.component_actions, 100, 'BASED_ON_RMIT_SIGNAGE', 'RMIT Vietnam pilot station signage and MVP rule brief', true
from rules
join site on true
...
select data.code, waste_items.id, null, data.title_vi, data.title_en, data.summary_vi, data.summary_en,
  ...
  'Easy', 10, 100, 'PENDING_RMIT_CONFIRMATION', true
from (
  values
